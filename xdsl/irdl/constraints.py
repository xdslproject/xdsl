...
class RangeOf(GenericRangeConstraint[AttributeCovT]):
    ...
    constr: GenericAttrConstraint[AttributeCovT]
    _: KW_ONLY
    # Ideally we would like an AnyIntConstr here but this causes import loops
    # `AnyAttr` won't infer anything so this *should* be safe.
    length: GenericAttrConstraint[IntAttr] = field(default_factory=AnyAttr)  # pyright: ignore
