...
class DialectOp(IRDLOperation):
    ...
    traits = Lazy(lambda: (NoTerminator(), SymbolOpInterface(), SymbolTable()))
...
class TypeOp(IRDLOperation):
    ...
    traits = Lazy(lambda: (NoTerminator(), HasParent(DialectOp), SymbolOpInterface()))
...
class ParametersOp(IRDLOperation):
    ...
    traits = Lazy(lambda: (HasParent(TypeOp, AttributeOp),))
...
class OperandsOp(IRDLOperation):
    ...
    traits = Lazy(lambda: (HasParent(OperationOp),))
...
class ResultsOp(IRDLOperation):
    ...
    traits = Lazy(lambda: (IsTerminator(), HasParent(OperationOp)))
