...
csl.func @initialize() {
    ...
    "csl.fadd"(%dsd_1d1, %dsd_1d2, %dsd_1d3) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fadd"(%f16_ptr, %f16_val, %dsd_1d3) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()
    // this will fail as expected:
    // "csl.fadd"(%f32_ptr, %f16_val, %dsd_1d3) <{"precision" = !csl<precision h>}>  : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()
...
csl.func @builtins() {
    ...
    "csl.add16"(%dest_dsd, %src_dsd1,  %src_dsd2)  <{"with_carry" = true}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.add16"(%dest_dsd, %i16_value, %src_dsd1)  <{"with_carry" = true}> : (!csl<dsd mem1d_dsd>, si16, !csl<dsd mem1d_dsd>) -> ()
    "csl.add16"(%dest_dsd, %u16_value, %src_dsd1)  <{"with_carry" = true}> : (!csl<dsd mem1d_dsd>, ui16, !csl<dsd mem1d_dsd>) -> ()
    "csl.add16"(%dest_dsd, %src_dsd1,  %i16_value) <{"with_carry" = true}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, si16) -> ()
    "csl.add16"(%dest_dsd, %src_dsd1,  %u16_value) <{"with_carry" = true}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, ui16) -> ()
    ...
    "csl.fabs"(%dest_dsd, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fabs"(%dest_dsd, %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16) -> ()

    "csl.fabs"(%dest_dsd, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fabs"(%dest_dsd, %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32) -> ()

    "csl.fadd"(%dest_dsd,    %src_dsd1,  %src_dsd2)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fadd"(%dest_dsd,    %f16_value, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16, !csl<dsd mem1d_dsd>) -> ()
    "csl.fadd"(%dest_dsd,    %src_dsd1,  %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
    "csl.fadd"(%f16_pointer, %f16_value, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()

    "csl.fadd"(%dest_dsd,    %src_dsd1,  %src_dsd2)  <{"precision" = !csl<precision hs>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fadd"(%dest_dsd,    %f16_value, %src_dsd1)  <{"precision" = !csl<precision hs>}> : (!csl<dsd mem1d_dsd>, f16, !csl<dsd mem1d_dsd>) -> ()
    "csl.fadd"(%dest_dsd,    %src_dsd1,  %f16_value) <{"precision" = !csl<precision hs>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
    "csl.fadd"(%f32_pointer, %f32_value, %src_dsd1)  <{"precision" = !csl<precision hs>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, !csl<dsd mem1d_dsd>) -> ()

    "csl.fadd"(%dest_dsd,    %src_dsd1,  %src_dsd2)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fadd"(%dest_dsd,    %f32_value, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32, !csl<dsd mem1d_dsd>) -> ()
    "csl.fadd"(%dest_dsd,    %src_dsd1,  %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f32) -> ()
    "csl.fadd"(%f32_pointer, %f32_value, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, !csl<dsd mem1d_dsd>) -> ()
    ...
    "csl.fmac"(%dest_dsd, %src_dsd1, %src_dsd2, %f16_value) <{"precision" = !csl<precision h>}>  : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
    "csl.fmac"(%dest_dsd, %src_dsd1, %src_dsd2, %f16_value) <{"precision" = !csl<precision hs>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
    "csl.fmac"(%dest_dsd, %src_dsd1, %src_dsd2, %f32_value) <{"precision" = !csl<precision s>}>  : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f32) -> ()

    "csl.fmax"(%dest_dsd,    %src_dsd1,  %src_dsd2)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmax"(%dest_dsd,    %f16_value, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmax"(%dest_dsd,    %src_dsd1,  %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
    "csl.fmax"(%f16_pointer, %f16_value, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()

    "csl.fmax"(%dest_dsd,    %src_dsd1,  %src_dsd2)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmax"(%dest_dsd,    %f32_value, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmax"(%dest_dsd,    %src_dsd1,  %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f32) -> ()
    "csl.fmax"(%f32_pointer, %f32_value, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, !csl<dsd mem1d_dsd>) -> ()

    "csl.fmov"(%dest_dsd,    %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmov"(%f16_pointer, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmov"(%dest_dsd,    %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16) -> ()

    "csl.fmov"(%dest_dsd,    %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmov"(%f32_pointer, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmov"(%dest_dsd,    %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32) -> ()

    "csl.fmul"(%dest_dsd,    %src_dsd1,  %src_dsd2)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmul"(%dest_dsd,    %f16_value, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmul"(%dest_dsd,    %src_dsd1,  %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
    "csl.fmul"(%f16_pointer, %f16_value, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()

    "csl.fmul"(%dest_dsd,    %src_dsd1,  %src_dsd2)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmul"(%dest_dsd,    %f32_value, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32, !csl<dsd mem1d_dsd>) -> ()
    "csl.fmul"(%dest_dsd,    %src_dsd1,  %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f32) -> ()
    "csl.fmul"(%f32_pointer, %f32_value, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, !csl<dsd mem1d_dsd>) -> ()

    "csl.fneg"(%dest_dsd, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fneg"(%dest_dsd, %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16) -> ()

    "csl.fneg"(%dest_dsd, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fneg"(%dest_dsd, %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32) -> ()

    "csl.fnorm"(%f16_pointer, %f16_value) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16) -> ()
    "csl.fnorm"(%f32_pointer, %f32_value) <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32) -> ()
    ...
    "csl.fscale"(%f16_pointer, %f16_value, %i16_value) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, si16) -> ()
    "csl.fscale"(%f32_pointer, %f32_value, %i16_value) <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, si16) -> ()

    "csl.fsub"(%dest_dsd,    %src_dsd1,  %src_dsd2)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fsub"(%dest_dsd,    %f16_value, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16, !csl<dsd mem1d_dsd>) -> ()
    "csl.fsub"(%dest_dsd,    %src_dsd1,  %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
    "csl.fsub"(%f16_pointer, %f16_value, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()

    "csl.fsub"(%dest_dsd,    %src_dsd1,  %src_dsd2)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fsub"(%dest_dsd,    %f32_value, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32, !csl<dsd mem1d_dsd>) -> ()
    "csl.fsub"(%dest_dsd,    %src_dsd1,  %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f32) -> ()
    "csl.fsub"(%f32_pointer, %f32_value, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, !csl<dsd mem1d_dsd>) -> ()

    "csl.mov"(%dest_dsd,    %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.mov"(%i16_pointer, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl.ptr<si16, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
    "csl.mov"(%u16_pointer, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl.ptr<ui16, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
    "csl.mov"(%dest_dsd,    %i16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, si16) -> ()
    "csl.mov"(%dest_dsd,    %u16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, ui16) -> ()

    "csl.mov"(%dest_dsd,    %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.mov"(%i32_pointer, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl.ptr<si32, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
    "csl.mov"(%u32_pointer, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl.ptr<ui32, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
    "csl.mov"(%dest_dsd,    %i32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, si32) -> ()
    "csl.mov"(%dest_dsd,    %u32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, ui32) -> ()
    ...
    "csl.xp162f"(%dest_dsd, %src_dsd1)  <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.xp162f"(%dest_dsd, %i16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, si16) -> ()
    "csl.xp162f"(%dest_dsd, %u16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, ui16) -> ()

    "csl.xp162f"(%dest_dsd, %src_dsd1)  <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.xp162f"(%dest_dsd, %i16_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, si16) -> ()
    "csl.xp162f"(%dest_dsd, %u16_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, ui16) -> ()
...
// CHECK-NEXT:     "csl.fadd"(%dsd_1d1, %dsd_1d2, %dsd_1d3) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fadd"(%f16_ptr, %f16_val, %dsd_1d3) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     csl.return
// CHECK-NEXT:   }
...
// CHECK-NEXT:     "csl.add16"(%dest_dsd, %src_dsd1, %src_dsd2) <{"with_carry" = true}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.add16"(%dest_dsd, %i16_value, %src_dsd1) <{"with_carry" = true}> : (!csl<dsd mem1d_dsd>, si16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.add16"(%dest_dsd, %u16_value, %src_dsd1) <{"with_carry" = true}> : (!csl<dsd mem1d_dsd>, ui16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.add16"(%dest_dsd, %src_dsd1, %i16_value) <{"with_carry" = true}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, si16) -> ()
// CHECK-NEXT:     "csl.add16"(%dest_dsd, %src_dsd1, %u16_value) <{"with_carry" = true}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, ui16) -> ()
...
// CHECK-NEXT:     "csl.fabs"(%dest_dsd, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fabs"(%dest_dsd, %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16) -> ()
// CHECK-NEXT:     "csl.fabs"(%dest_dsd, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fabs"(%dest_dsd, %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32) -> ()
// CHECK-NEXT:     "csl.fadd"(%dest_dsd, %src_dsd1, %src_dsd2) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fadd"(%dest_dsd, %f16_value, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fadd"(%dest_dsd, %src_dsd1, %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
// CHECK-NEXT:     "csl.fadd"(%f16_pointer, %f16_value, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fadd"(%dest_dsd, %src_dsd1, %src_dsd2) <{"precision" = !csl<precision hs>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fadd"(%dest_dsd, %f16_value, %src_dsd1) <{"precision" = !csl<precision hs>}> : (!csl<dsd mem1d_dsd>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fadd"(%dest_dsd, %src_dsd1, %f16_value) <{"precision" = !csl<precision hs>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
// CHECK-NEXT:     "csl.fadd"(%f32_pointer, %f32_value, %src_dsd1) <{"precision" = !csl<precision hs>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fadd"(%dest_dsd, %src_dsd1, %src_dsd2) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fadd"(%dest_dsd, %f32_value, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fadd"(%dest_dsd, %src_dsd1, %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f32) -> ()
// CHECK-NEXT:     "csl.fadd"(%f32_pointer, %f32_value, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, !csl<dsd mem1d_dsd>) -> ()
...
// CHECK-NEXT:     "csl.fmac"(%dest_dsd, %src_dsd1, %src_dsd2, %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
// CHECK-NEXT:     "csl.fmac"(%dest_dsd, %src_dsd1, %src_dsd2, %f16_value) <{"precision" = !csl<precision hs>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
// CHECK-NEXT:     "csl.fmac"(%dest_dsd, %src_dsd1, %src_dsd2, %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f32) -> ()
// CHECK-NEXT:     "csl.fmax"(%dest_dsd, %src_dsd1, %src_dsd2) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmax"(%dest_dsd, %f16_value, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmax"(%dest_dsd, %src_dsd1, %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
// CHECK-NEXT:     "csl.fmax"(%f16_pointer, %f16_value, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmax"(%dest_dsd, %src_dsd1, %src_dsd2) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmax"(%dest_dsd, %f32_value, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmax"(%dest_dsd, %src_dsd1, %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f32) -> ()
// CHECK-NEXT:     "csl.fmax"(%f32_pointer, %f32_value, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmov"(%dest_dsd, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmov"(%f16_pointer, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmov"(%dest_dsd, %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16) -> ()
// CHECK-NEXT:     "csl.fmov"(%dest_dsd, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmov"(%f32_pointer, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmov"(%dest_dsd, %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32) -> ()
// CHECK-NEXT:     "csl.fmul"(%dest_dsd, %src_dsd1, %src_dsd2) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmul"(%dest_dsd, %f16_value, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmul"(%dest_dsd, %src_dsd1, %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
// CHECK-NEXT:     "csl.fmul"(%f16_pointer, %f16_value, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmul"(%dest_dsd, %src_dsd1, %src_dsd2) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmul"(%dest_dsd, %f32_value, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fmul"(%dest_dsd, %src_dsd1, %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f32) -> ()
// CHECK-NEXT:     "csl.fmul"(%f32_pointer, %f32_value, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fneg"(%dest_dsd, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fneg"(%dest_dsd, %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16) -> ()
// CHECK-NEXT:     "csl.fneg"(%dest_dsd, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fneg"(%dest_dsd, %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32) -> ()
// CHECK-NEXT:     "csl.fnorm"(%f16_pointer, %f16_value) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16) -> ()
// CHECK-NEXT:     "csl.fnorm"(%f32_pointer, %f32_value) <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32) -> ()
...
// CHECK-NEXT:     "csl.fscale"(%f16_pointer, %f16_value, %i16_value) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, si16) -> ()
// CHECK-NEXT:     "csl.fscale"(%f32_pointer, %f32_value, %i16_value) <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, si16) -> ()
// CHECK-NEXT:     "csl.fsub"(%dest_dsd, %src_dsd1, %src_dsd2) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fsub"(%dest_dsd, %f16_value, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fsub"(%dest_dsd, %src_dsd1, %f16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f16) -> ()
// CHECK-NEXT:     "csl.fsub"(%f16_pointer, %f16_value, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fsub"(%dest_dsd, %src_dsd1, %src_dsd2) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fsub"(%dest_dsd, %f32_value, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, f32, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fsub"(%dest_dsd, %src_dsd1, %f32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, f32) -> ()
// CHECK-NEXT:     "csl.fsub"(%f32_pointer, %f32_value, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl.ptr<f32, #csl<ptr_kind single>, #csl<ptr_const var>>, f32, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.mov"(%dest_dsd, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.mov"(%i16_pointer, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl.ptr<si16, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.mov"(%u16_pointer, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl.ptr<ui16, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.mov"(%dest_dsd, %i16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, si16) -> ()
// CHECK-NEXT:     "csl.mov"(%dest_dsd, %u16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, ui16) -> ()
// CHECK-NEXT:     "csl.mov"(%dest_dsd, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.mov"(%i32_pointer, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl.ptr<si32, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.mov"(%u32_pointer, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl.ptr<ui32, #csl<ptr_kind single>, #csl<ptr_const var>>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.mov"(%dest_dsd, %i32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, si32) -> ()
// CHECK-NEXT:     "csl.mov"(%dest_dsd, %u32_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, ui32) -> ()
...
// CHECK-NEXT:     "csl.xp162f"(%dest_dsd, %src_dsd1) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.xp162f"(%dest_dsd, %i16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, si16) -> ()
// CHECK-NEXT:     "csl.xp162f"(%dest_dsd, %u16_value) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, ui16) -> ()
// CHECK-NEXT:     "csl.xp162f"(%dest_dsd, %src_dsd1) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.xp162f"(%dest_dsd, %i16_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, si16) -> ()
// CHECK-NEXT:     "csl.xp162f"(%dest_dsd, %u16_value) <{"precision" = !csl<precision s>}> : (!csl<dsd mem1d_dsd>, ui16) -> ()
// CHECK-NEXT:     csl.return
// CHECK-NEXT:   }
