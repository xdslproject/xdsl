...
def simple_linear_riscv_allocated():
    ...
    def text_region():
        ...
        def main_region() -> None:
            ...
            v1 = riscv.AddiOp(zero, 2, rd=riscv.Registers.S10).rd

            v3 = riscv.AddOp(v1, v0, rd=riscv.Registers.S9).rd
            v4 = riscv.MulOp(v3, v1, rd=riscv.Registers.S8).rd
            v5 = riscv.SubOp(v0, v4, rd=riscv.Registers.S7).rd
            v6 = riscv.MulOp(v1, v0, rd=riscv.Registers.S6).rd
            v7 = riscv.AddOp(v6, v3, rd=riscv.Registers.S5).rd
            v8 = riscv.AddOp(v7, v5, rd=riscv.Registers.S4).rd
            v9 = riscv.SubOp(v0, v1, rd=riscv.Registers.S3).rd
            v10 = riscv.MulOp(v5, v3, rd=riscv.Registers.S2).rd
            v11 = riscv.AddOp(v9, v10, rd=riscv.Registers.S1).rd
            v12 = riscv.AddOp(v11, v8, rd=riscv.Registers.T6).rd
            v13 = riscv.AddOp(v4, v0, rd=riscv.Registers.T5).rd
            v14 = riscv.SubOp(v13, v5, rd=riscv.Registers.T4).rd
            v15 = riscv.MulOp(v12, v8, rd=riscv.Registers.T3).rd
            v16 = riscv.AddOp(v14, v15, rd=riscv.Registers.T2).rd

            v18 = riscv.FCvtSWOp(v16, rd=riscv.Registers.FS11).rd
            v19 = riscv.FCvtSWOp(v18, rd=riscv.Registers.FS10).rd
            _ = riscv.FAddSOp(v18, v19, rd=riscv.Registers.FS9).rd
