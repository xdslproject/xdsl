...
builtin.module {
  ...
  // CHECK: func.func @arg_rec_block(%1 : !test.type<"int">) -> !test.type<"int"> {
  // CHECK-NEXT:   %2 = func.call @arg_rec_block(%1) : (!test.type<"int">) -> !test.type<"int">
  // CHECK-NEXT:   func.return %2 : !test.type<"int">
  // CHECK-NEXT: }
