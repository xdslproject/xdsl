...
%5 = "riscv.add"(%3, %4) : (!riscv.reg<x$>, !riscv.reg<x$>) -> !riscv.reg<x$>
...
%10 = "riscv.li"() {"immediate" = 2 : i32} : () -> !riscv.reg<x$>
%11 = "riscv.li"() {"immediate" = 1 : i32} : () -> !riscv.reg<x$>
%12 = "riscv.fcvt.s.w"(%10) : (!riscv.reg<x$>) -> !riscv.freg<f$>
%13 = "riscv.fcvt.s.w"(%11) : (!riscv.reg<x$>) -> !riscv.freg<f$>
%14 = "riscv.fadd.s"(%12, %13) : (!riscv.freg<f$>, !riscv.freg<f$>) -> !riscv.freg<f$>
