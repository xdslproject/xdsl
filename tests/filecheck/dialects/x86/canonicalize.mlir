...
// CHECK-NEXT:     x86.ms.mov [%i0 + 40], %rm_mov : (!x86.reg64<rdi>, !x86.reg64<rax>) -> ()
%rm_mov = x86.dm.mov [%offset_ptr + 8] : (!x86.reg64) -> !x86.reg64<rax>
x86.ms.mov [%offset_ptr + 8], %rm_mov : (!x86.reg64, !x86.reg64<rax>) -> ()

// CHECK-NEXT:     %avx = x86.dm.vmovupd [%i0 + 64] : (!x86.reg64<rdi>) -> !x86.avx2reg<ymm1>
// CHECK-NEXT:     x86.ms.vmovapd [%i0 + 64], %avx : (!x86.reg64<rdi>, !x86.avx2reg<ymm1>) -> ()
%avx = x86.dm.vmovupd [%offset_ptr + 32] : (!x86.reg64) -> !x86.avx2reg<ymm1>
x86.ms.vmovapd [%offset_ptr + 32], %avx : (!x86.reg64, !x86.avx2reg<ymm1>) -> ()
