...
// CHECK-NEXT:     ^1(%9 : index):
// CHECK-NEXT:       "scf.for"(%4, %7, %5) ({
// CHECK-NEXT:       ^2(%10 : index):
// CHECK-NEXT:         "scf.for"(%4, %8, %5) ({
// CHECK-NEXT:         ^3(%11 : index):
...
// CHECK-NEXT:   "func.func"() ({
// CHECK-NEXT:   ^4(%14 : f32, %15 : memref<?x?x?xf32>):
...
// CHECK-NEXT:     "scf.parallel"(%18, %20, %19) ({
// CHECK-NEXT:     ^5(%23 : index):
// CHECK-NEXT:       "scf.for"(%18, %21, %19) ({
// CHECK-NEXT:       ^6(%24 : index):
// CHECK-NEXT:         "scf.for"(%18, %22, %19) ({
// CHECK-NEXT:         ^7(%25 : index):
