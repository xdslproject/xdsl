...
def test_arith_conversion():
    test_prog = """
module() {
  builtin.func() ["sym_name" = "test", "type" = !fun<[!i32], [!i32]>, "sym_visibility" = "private"]{
  ^0(%arg : !i32):
...
def test_memref_conversion():
    test_prog = """
module() {
  builtin.func() ["sym_name" = "sum", "type" = !fun<[!i32, !i32], [!i32]>, "sym_visibility" = "public"]{
  ^0(%0 : !i32, %1 : !i32):
