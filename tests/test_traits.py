...
@pytest.mark.parametrize(
    (
        "operand_and_result_element_type1",
...
def test_same_operands_and_result_type_trait_for_result_element_type_of_shaped_types(
    operand_and_result_element_type1: Attribute,
    ...
    op = SameOperandsAndResultTypeOp(
        operands=[
            TestSSAValue(
                TensorType(operand_and_result_element_type1, operand_and_result_shape1)
            )
        ],
        result_types=[
            [
...
def test_same_operands_and_result_type_trait_for_element_type_of_shaped_types(
    ...
    operands_num: tuple[int],
    results_num: tuple[int],
):
    for operand_num in operands_num:
        for result_num in results_num:
            op = SameOperandsAndResultTypeOp(
                ...
                result_types=[
                    [TensorType(result_element_type, result_shape)] * result_num
                ],
            )
    ...
    for operand_num in operands_num:
        for result_num in results_num:
            op = SameOperandsAndResultTypeOp(
                ...
                result_types=[
                    [MemRefType(result_element_type, result_shape)] * result_num
                ],
            )
...
def test_same_operands_and_result_type_trait_for_result_encoding_of_shaped_types(
    ...
    shape: tuple[int],
    operand_and_result_encoding1: Attribute,
    ...
    op = SameOperandsAndResultTypeOp(
        ...
        result_types=[
            [
                TensorType(element_type, shape, operand_and_result_encoding1),
    ...
    for operand_num in operands_num:
        for result_num in results_num:
            op = SameOperandsAndResultTypeOp(
                ...
                result_types=[
                    [TensorType(element_type, shape, result_encoding)] * result_num
                ],
            )
