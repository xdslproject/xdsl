...
class MachineOp(IRDLOperation):
    ...
    traits = OpTraits({NoTerminator(), SymbolTable(), SymbolOpInterface()})
...
class StateOp(IRDLOperation):
    ...
    traits = OpTraits({NoTerminator(), SymbolOpInterface(), HasParent(MachineOp)})
...
class OutputOp(IRDLOperation):
    ...
    traits = OpTraits({IsTerminator(), HasParent(StateOp)})
...
class TransitionOp(IRDLOperation):
    ...
    traits = OpTraits({NoTerminator(), HasParent(StateOp)})
...
class UpdateOp(IRDLOperation):
    ...
    traits = OpTraits({HasParent(TransitionOp)})
...
class ReturnOp(IRDLOperation):
    ...
    traits = OpTraits({IsTerminator(), HasParent(TransitionOp)})
