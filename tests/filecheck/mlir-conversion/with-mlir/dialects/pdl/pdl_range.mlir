...
// CHECK: @emptyRanges
  ...
  // CHECK: %{{\d+}} = pdl.range : !pdl.range<type>
    %values = pdl.range : !pdl.range<value>
  // CHECK: %{{\d+}} = pdl.range : !pdl.range<value>
