...
csl.func @initialize() {
    ...
    "csl.fadds"(%dsd_1d1, %dsd_1d2, %dsd_1d3) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
    "csl.fadds"(%f16_ptr, %f16_val, %dsd_1d3) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()
...
// CHECK-NEXT:     "csl.fadds"(%dsd_1d1, %dsd_1d2, %dsd_1d3) <{"precision" = !csl<precision h>}> : (!csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     "csl.fadds"(%f16_ptr, %f16_val, %dsd_1d3) <{"precision" = !csl<precision h>}> : (!csl.ptr<f16, #csl<ptr_kind single>, #csl<ptr_const var>>, f16, !csl<dsd mem1d_dsd>) -> ()
// CHECK-NEXT:     csl.return
// CHECK-NEXT:   }
