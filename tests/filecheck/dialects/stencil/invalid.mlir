...
// CHECK: Expected stencil.buffer to buffer a stencil.apply or stencil.combine's output, got Block(_args=(<BlockArgument[!stencil.temp<[0,68]xf64>] index: 0, uses: (<Use operation: stencil.buffer, index: 0>,)>,), num_ops=2)
