...
try:
    with CodeContext(p):
        ...
        def test_not_supported_loop_I():
            for i in range(10):  # pyright: ignore[reportUnusedVariable]
                pass
            else:
                pass
            return
...
try:
    with CodeContext(p):
        ...
        def test_not_supported_loop_II():
            for i, j in enumerate(range(10, 0, -1)):  # pyright: ignore[reportUnusedVariable]
                pass
            return
...
try:
    with CodeContext(p):
        ...
        def test_not_supported_loop_III():
            for i in range(0, 1, 2, 3):  # pyright: ignore[reportUnusedVariable, reportCallIssue]
                pass
            return
...
try:
    with CodeContext(p):
        ...
        def test_not_supported_loop_IV():
            for i, j in range(100):  # pyright: ignore[reportUnusedVariable, reportUnknownVariableType, reportGeneralTypeIssues]
                pass
            return
