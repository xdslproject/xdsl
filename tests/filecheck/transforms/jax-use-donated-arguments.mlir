...
// CHECK-NEXT:     %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d2, d1)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%arg0, %arg1 : tensor<2x3xf32>, tensor<3x4xf32>) outs(%0 : tensor<2x4xf32>) {
...
// CHECK-NEXT:     func.return %1 : tensor<2x4xf32>
// CHECK-NEXT:   }
// CHECK-NEXT: }
