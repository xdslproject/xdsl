...
class Norm(Operation):
    ...
    op = OperandDef(ParamAttrConstraint(ComplexType, [AnyOf([Float32Type, Float64Type])] ) )
...
class Mul(Operation):
    ...
    res = ResultDef(ParamAttrConstraint(ComplexType, [AnyOf([Float32Type, Float64Type])]))
