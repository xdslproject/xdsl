// RUN: xdsl-opt --print-op-generic %s | $XDSL_MLIR_OPT --mlir-print-op-generic | xdsl-opt --print-op-generic | filecheck %s
...
// CHECK-NEXT: ^bb0(%arg0: tensor<8x8xf64>, %arg1: tensor<8x8xf64>):
