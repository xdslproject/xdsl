...
from xdsl.dialects.qssa import Qubits, Angle, Alloc, Measure, Dim, Merge, Split, CNOT, PauliRotate, Pauli, SGate, HGate, TGate, EulerUnitaryGate, MatrixGate 
...
def test_alloc_constructor(q5_type):
    q5 = Alloc.build(result_types=[q5_type], attributes={"n_qubits": IntAttr.from_int(5)})
