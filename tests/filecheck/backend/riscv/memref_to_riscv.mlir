...
// CHECK-NEXT:    %pointer_dim_stride = rv32.li 2 : !riscv.reg
...
// CHECK-NEXT:    %bytes_per_element = rv32.li 4 : !riscv.reg
...
// CHECK-NEXT:    %pointer_dim_stride_1 = rv32.li 2 : !riscv.reg
...
// CHECK-NEXT:    %bytes_per_element_1 = rv32.li 4 : !riscv.reg
...
// CHECK-NEXT:    %bytes_per_element_2 = rv32.li 4 : !riscv.reg
...
// CHECK-NEXT:    %bytes_per_element_3 = rv32.li 4 : !riscv.reg
...
// CHECK-NEXT:    %pointer_dim_stride_2 = rv32.li 2 : !riscv.reg
...
// CHECK-NEXT:    %bytes_per_element_4 = rv32.li 8 : !riscv.reg
...
// CHECK-NEXT:    %pointer_dim_stride_3 = rv32.li 2 : !riscv.reg
...
// CHECK-NEXT:    %bytes_per_element_5 = rv32.li 8 : !riscv.reg
...
// CHECK-NEXT:    %m0 = rv32.li 4 {comment = "memref alloc size"} : !riscv.reg
...
// CHECK-NEXT:    %bytes_per_element = rv32.li 1 : !riscv.reg
...
// CHECK-NEXT:    %d0_1 = builtin.unrealized_conversion_cast %d0 : index to !riscv.reg
// CHECK-NEXT:    %bytes_per_element = rv32.li 2 : !riscv.reg
// CHECK-NEXT:    %scaled_pointer_offset = riscv.mul %d0_1, %bytes_per_element {comment = "multiply by element size"} : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:    %offset_pointer = riscv.add %m_1, %scaled_pointer_offset : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:    riscv.sw %offset_pointer, %v_1, 0 {comment = "store int value to memref of shape (1,)"} : (!riscv.reg, !riscv.reg) -> ()
...
// CHECK-NEXT:    %d0_1 = builtin.unrealized_conversion_cast %d0 : index to !riscv.reg
// CHECK-NEXT:    %bytes_per_element = rv32.li 8 : !riscv.reg
// CHECK-NEXT:    %scaled_pointer_offset = riscv.mul %d0_1, %bytes_per_element {comment = "multiply by element size"} : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:    %offset_pointer = riscv.add %m_1, %scaled_pointer_offset : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:    riscv.sw %offset_pointer, %v_1, 0 {comment = "store int value to memref of shape (1,)"} : (!riscv.reg, !riscv.reg) -> ()
...
// CHECK-NEXT:    %subview_dim_index_1 = rv32.li 0 : !riscv.reg
// CHECK-NEXT:    %subview_dim_index_2 = rv32.li 0 : !riscv.reg
// CHECK-NEXT:    %pointer_dim_stride = rv32.li 6 : !riscv.reg
...
// CHECK-NEXT:    %subview_dim_index_5 = rv32.li 0 : !riscv.reg
// CHECK-NEXT:    %subview_dim_index_6 = rv32.li 0 : !riscv.reg
// CHECK-NEXT:    %pointer_dim_stride_2 = rv32.li 24 : !riscv.reg
// CHECK-NEXT:    %pointer_dim_offset_2 = riscv.mul %subview_dim_index_3, %pointer_dim_stride_2 : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:    %pointer_dim_stride_3 = rv32.li 6 : !riscv.reg
...
// CHECK-NEXT:    %pointer_dim_stride_4 = rv32.li 2 : !riscv.reg
...
// CHECK-NEXT:    %bytes_per_element_1 = rv32.li 8 : !riscv.reg
...
// CHECK-NEXT:    %pointer_dim_stride = rv32.li 6
...
// CHECK-NEXT:    %bytes_per_element = rv32.li 8
