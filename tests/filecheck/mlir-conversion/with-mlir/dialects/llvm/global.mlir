...
// CHECK-NEXT:   }) {"addr_space" = 0 : i32, "constant", "global_type" = !llvm.array<12 x i8>, "linkage" = #llvm.linkage<"internal">, "sym_name" = "str0", "unnamed_addr" = 0 : i64, "value" = "Hello world!", "visibility_" = 0 : i64} : () -> ()
// CHECK-NEXT:   "llvm.mlir.global"() ({
// CHECK-NEXT:   }) {"addr_space" = 0 : i32, "constant", "global_type" = i32, "linkage" = #llvm.linkage<"internal">, "sym_name" = "data", "unnamed_addr" = 0 : i64, "value" = 0 : i32, "visibility_" = 0 : i64} : () -> ()
