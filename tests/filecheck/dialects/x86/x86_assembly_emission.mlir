...
%rr_vmovapd_sse = x86.rs.vmovapd %rrr_vfmadd231pd_sse, %xmm1 : (!x86.ssereg<xmm0>, !x86.ssereg<xmm1>) -> !x86.ssereg<xmm0>
...
%rr_vmovapd_avx2 = x86.rs.vmovapd %rrr_vfmadd231pd_avx2, %ymm1 : (!x86.avx2reg<ymm0>, !x86.avx2reg<ymm1>) -> !x86.avx2reg<ymm0>
...
%rr_vmovapd_avx512 = x86.rs.vmovapd %rrr_vfmadd231pd_avx512, %zmm1 : (!x86.avx512reg<zmm0>, !x86.avx512reg<zmm1>) -> !x86.avx512reg<zmm0>
...
%rrr_vfmadd231ps_sse = x86.rss.vfmadd231ps %rr_vmovapd_sse, %xmm1, %xmm2 : (!x86.ssereg<xmm0>, !x86.ssereg<xmm1>, !x86.ssereg<xmm2>) -> !x86.ssereg<xmm0>
// CHECK: vfmadd231ps xmm0, xmm1, xmm2
%rrr_vfmadd231ps_avx2 = x86.rss.vfmadd231ps %rr_vmovapd_avx2, %ymm1, %ymm2 : (!x86.avx2reg<ymm0>, !x86.avx2reg<ymm1>, !x86.avx2reg<ymm2>) -> !x86.avx2reg<ymm0>
