...
riscv_func.func @main() {
  ...
  riscv_scf.for %6 = %0 to %1 step %5 : !riscv.reg {
  }

  %7 = riscv_scf.for %8 = %0 to %1 step %5 iter_args(%9 = %5) -> (!riscv.reg) : !riscv.reg {
...
//   CHECK-LIVENESS-BLOCK-NAIVE-NEXT:      riscv_scf.for %6 = %0 to %1 step %5 : !riscv.reg<t2> {
//   CHECK-LIVENESS-BLOCK-NAIVE-NEXT:      }
//   CHECK-LIVENESS-BLOCK-NAIVE-NEXT:      %7 = riscv_scf.for %8 = %0 to %1 step %5 iter_args(%9 = %5) -> (!riscv.reg<t0>) : !riscv.reg<t1> {
...
//   CHECK-LIVENESS-BLOCK-NAIVE-J-NEXT:      riscv_scf.for %6 = %0 to %1 step %5 : !riscv.reg<j2> {
//   CHECK-LIVENESS-BLOCK-NAIVE-J-NEXT:      }
//   CHECK-LIVENESS-BLOCK-NAIVE-J-NEXT:      %7 = riscv_scf.for %8 = %0 to %1 step %5 iter_args(%9 = %5) -> (!riscv.reg<j0>) : !riscv.reg<j1> {
