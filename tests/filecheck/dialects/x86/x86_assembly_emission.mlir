...
// CHECK-NEXT: add [rax], rdx
x86.ms.add %rax, %1, 8 : (!x86.reg64<rax>, !x86.reg64<rdx>) -> ()
// CHECK-NEXT: add [rax+8], rdx
x86.ms.sub %rax, %1, -8 : (!x86.reg64<rax>, !x86.reg64<rdx>) -> ()
// CHECK-NEXT: sub [rax-8], rdx
x86.ms.and %rax, %1, 8 : (!x86.reg64<rax>, !x86.reg64<rdx>) -> ()
// CHECK-NEXT: and [rax+8], rdx
x86.ms.or %rax, %1, 8 : (!x86.reg64<rax>, !x86.reg64<rdx>) -> ()
// CHECK-NEXT: or [rax+8], rdx
x86.ms.xor %rax, %1, 8 : (!x86.reg64<rax>, !x86.reg64<rdx>) -> ()
// CHECK-NEXT: xor [rax+8], rdx
x86.ms.mov %rax, %1, 8 : (!x86.reg64<rax>, !x86.reg64<rdx>) -> ()
// CHECK-NEXT: mov [rax+8], rdx
%mr_cmp = x86.ms.cmp %rax, %1, 8 : (!x86.reg64<rax>, !x86.reg64<rdx>) -> !x86.rflags<rflags>
// CHECK-NEXT: cmp [rax+8], rdx

x86.mi.add %rax, 2, 0 : (!x86.reg64<rax>) -> ()
// CHECK-NEXT: add [rax], 2
x86.mi.add %rax, 2 : (!x86.reg64<rax>) -> ()
// CHECK-NEXT: add [rax], 2
x86.mi.add %rax, 2, 8 : (!x86.reg64<rax>) -> ()
// CHECK-NEXT: add [rax+8], 2
x86.mi.sub %rax, 2, -8 : (!x86.reg64<rax>) -> ()
// CHECK-NEXT: sub [rax-8], 2
x86.mi.and %rax, 2, 8 : (!x86.reg64<rax>) -> ()
// CHECK-NEXT: and [rax+8], 2
x86.mi.or %rax, 2, 8 : (!x86.reg64<rax>) -> ()
// CHECK-NEXT: or [rax+8], 2
x86.mi.xor %rax, 2, 8 : (!x86.reg64<rax>) -> ()
// CHECK-NEXT: xor [rax+8], 2
x86.mi.mov %rax, 2, 8 : (!x86.reg64<rax>) -> ()
// CHECK-NEXT: mov [rax+8], 2
%mi_cmp = x86.mi.cmp %rax, 2, 8 : !x86.reg64<rax> -> !x86.rflags<rflags>
...
// CHECK-NEXT: imul rax, [rdx], 2
%rmi_imul_offset_zero = x86.dmi.imul %1, 2, 0 : (!x86.reg64<rdx>) -> !x86.reg64<rax>
// CHECK-NEXT: imul rax, [rdx], 2
%rmi_imul = x86.dmi.imul %1, 2, 8 : (!x86.reg64<rdx>) -> !x86.reg64<rax>
...
// CHECK-NEXT: idiv [rcx]
%m_idiv_rdx0, %m_idiv_rax0 = x86.m.idiv %2, %1, %m_idiv_rax, 0 : (!x86.reg64<rcx>, !x86.reg64<rdx>, !x86.reg64<rax>) -> (!x86.reg64<rdx>, !x86.reg64<rax>)
// CHECK-NEXT: idiv [rcx]
%m_idiv_rdx2, %m_idiv_rax2 = x86.m.idiv %2, %1, %m_idiv_rax0, 8 : (!x86.reg64<rcx>, !x86.reg64<rdx>, !x86.reg64<rax>) -> (!x86.reg64<rdx>, !x86.reg64<rax>)
// CHECK-NEXT: idiv [rcx+8]
%m_imul_rdx, %m_imul_rax = x86.m.imul %2, %m_idiv_rax2, 8 : (!x86.reg64<rcx>, !x86.reg64<rax>) -> (!x86.reg64<rdx>, !x86.reg64<rax>)
...
x86.ms.vmovapd %1, %xmm1, 8 : (!x86.reg64<rdx>, !x86.ssereg<xmm1>) -> ()
// CHECK: vmovapd [rdx+8], xmm1
x86.ms.vmovapd %1, %ymm1, 8 : (!x86.reg64<rdx>, !x86.avx2reg<ymm1>) -> ()
// CHECK: vmovapd [rdx+8], ymm1
x86.ms.vmovapd %1, %zmm1, 8 : (!x86.reg64<rdx>, !x86.avx512reg<zmm1>) -> ()
...
x86.ms.vmovaps %1, %xmm1, 8 : (!x86.reg64<rdx>, !x86.ssereg<xmm1>) -> ()
// CHECK: vmovaps [rdx+8], xmm1
x86.ms.vmovaps %1, %ymm1, 8 : (!x86.reg64<rdx>, !x86.avx2reg<ymm1>) -> ()
// CHECK: vmovaps [rdx+8], ymm1
x86.ms.vmovaps %1, %zmm1, 8 : (!x86.reg64<rdx>, !x86.avx512reg<zmm1>) -> ()
...
x86.ms.vmovupd %1, %xmm1, 8 : (!x86.reg64<rdx>, !x86.ssereg<xmm1>) -> ()
// CHECK: vmovupd [rdx+8], xmm1
x86.ms.vmovupd %1, %ymm1, 8 : (!x86.reg64<rdx>, !x86.avx2reg<ymm1>) -> ()
// CHECK: vmovupd [rdx+8], ymm1
x86.ms.vmovupd %1, %zmm1, 8 : (!x86.reg64<rdx>, !x86.avx512reg<zmm1>) -> ()
...
x86.ms.vmovups %1, %xmm1, 8 : (!x86.reg64<rdx>, !x86.ssereg<xmm1>) -> ()
// CHECK: vmovups [rdx+8], xmm1
x86.ms.vmovups %1, %ymm1, 8 : (!x86.reg64<rdx>, !x86.avx2reg<ymm1>) -> ()
// CHECK: vmovups [rdx+8], ymm1
x86.ms.vmovups %1, %zmm1, 8 : (!x86.reg64<rdx>, !x86.avx512reg<zmm1>) -> ()
// CHECK: vmovups [rdx+8], zmm1

// ---- vmovntpd ----
x86.ms.vmovntpd %1, %xmm1, 8 : (!x86.reg64<rdx>, !x86.ssereg<xmm1>) -> ()
// CHECK: vmovntpd [rdx+8], xmm1
x86.ms.vmovntpd %1, %ymm1, 8 : (!x86.reg64<rdx>, !x86.avx2reg<ymm1>) -> ()
// CHECK: vmovntpd [rdx+8], ymm1
x86.ms.vmovntpd %1, %zmm1, 8 : (!x86.reg64<rdx>, !x86.avx512reg<zmm1>) -> ()
// CHECK: vmovntpd [rdx+8], zmm1

// ---- vmovntps ----
x86.ms.vmovntps %1, %xmm1, 8 : (!x86.reg64<rdx>, !x86.ssereg<xmm1>) -> ()
// CHECK: vmovntps [rdx+8], xmm1
x86.ms.vmovntps %1, %ymm1, 8 : (!x86.reg64<rdx>, !x86.avx2reg<ymm1>) -> ()
// CHECK: vmovntps [rdx+8], ymm1
x86.ms.vmovntps %1, %zmm1, 8 : (!x86.reg64<rdx>, !x86.avx512reg<zmm1>) -> ()
