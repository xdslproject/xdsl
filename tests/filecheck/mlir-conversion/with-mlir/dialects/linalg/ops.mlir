...
%constant = arith.constant 0.0 : f32
%fill = linalg.fill ins(%constant : f32) outs(%2 : tensor<2x3xf32>) -> tensor<2x3xf32>
...
// CHECK-NEXT:    %6 = linalg.fill ins(%5 : f32) outs(%2 : tensor<2x3xf32>) -> tensor<2x3xf32>
// CHECK-NEXT:  }
