...
"builtin.module"() ({
  ...
  %8 = "llvm.alloca"(%0) {"alignment" = 32 : i64} : (i64) -> !llvm.ptr<i64>
  %9 = "llvm.getelementptr"(%8, %0){result_type = i64, rawConstantIndices = array<i32:-2147483648>} : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i32>
