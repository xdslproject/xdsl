...
x86.ss.cmp %rax, %1 : (!x86.reg<rax>, !x86.reg<rdx>) -> ()
...
x86.sm.cmp %rm_mov, %1, 8 : (!x86.reg<rax>, !x86.reg<rdx>) -> ()
...
x86.si.cmp %di_mov, 2 : (!x86.reg<rax>) -> ()
...
x86.ms.cmp %rax, %1, 8 : (!x86.reg<rax>, !x86.reg<rdx>) -> ()
...
x86.mi.cmp %rax, 2, 8 : (!x86.reg<rax>) -> ()
...
x86_func.func @funcyasm() {
    ...
    x86.ss.cmp %3, %4 : (!x86.reg<rax>, !x86.reg<rdx>) -> ()
    // CHECK: cmp rax, rdx
...
%rrm_vfmadd231pd_sse_no_offset = x86.rsm.vfmadd231pd %xmm3, %xmm4, %1 : (!x86.ssereg<xmm3>, !x86.ssereg<xmm4>, !x86.reg<rdx>) -> !x86.ssereg<xmm3>
// CHECK: vfmadd231pd xmm3, xmm4, [rdx]
%rrm_vfmadd231ps_sse = x86.rsm.vfmadd231ps %xmm5, %xmm6, %1, 1 : (!x86.ssereg<xmm5>, !x86.ssereg<xmm6>, !x86.reg<rdx>) -> !x86.ssereg<xmm5>
// CHECK: vfmadd231ps xmm5, xmm6, [rdx+1]
...
%rrm_vfmadd231pd_avx2_no_offset = x86.rsm.vfmadd231pd %ymm3, %ymm4, %1 : (!x86.avx2reg<ymm3>, !x86.avx2reg<ymm4>, !x86.reg<rdx>) -> !x86.avx2reg<ymm3>
// CHECK: vfmadd231pd ymm3, ymm4, [rdx]
%rrm_vfmadd231ps_avx2 = x86.rsm.vfmadd231ps %ymm5, %ymm6, %1, 1 : (!x86.avx2reg<ymm5>, !x86.avx2reg<ymm6>, !x86.reg<rdx>) -> !x86.avx2reg<ymm5>
// CHECK: vfmadd231ps ymm5, ymm6, [rdx+1]
...
%rrm_vfmadd231pd_avx512_no_offset = x86.rsm.vfmadd231pd %zmm3, %zmm4, %1 : (!x86.avx512reg<zmm3>, !x86.avx512reg<zmm4>, !x86.reg<rdx>) -> !x86.avx512reg<zmm3>
// CHECK: vfmadd231pd zmm3, zmm4, [rdx]
%rrm_vfmadd231ps_avx512 = x86.rsm.vfmadd231ps %zmm5, %zmm6, %1, 1 : (!x86.avx512reg<zmm5>, !x86.avx512reg<zmm6>, !x86.reg<rdx>) -> !x86.avx512reg<zmm5>
// CHECK: vfmadd231ps zmm5, zmm6, [rdx+1]
