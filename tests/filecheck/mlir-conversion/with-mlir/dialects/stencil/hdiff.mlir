...
// CHECK-NEXT:     %subview = memref.subview %cast[0, 0, 0] [72, 72, 72] [1, 1, 1] : memref<72x72x72xf64> to memref<72x72x72xf64, strided<[5184, 72, 1]>>
...
// CHECK-NEXT:       %3 = memref.load %subview[%0, %1, %2] : memref<72x72x72xf64, strided<[5184, 72, 1]>>
...
// CHECK-NEXT:       %7 = memref.load %subview[%4, %5, %6] : memref<72x72x72xf64, strided<[5184, 72, 1]>>
...
// CHECK-NEXT:       %11 = memref.load %subview[%8, %9, %10] : memref<72x72x72xf64, strided<[5184, 72, 1]>>
...
// CHECK-NEXT:       %15 = memref.load %subview[%12, %13, %14] : memref<72x72x72xf64, strided<[5184, 72, 1]>>
...
// CHECK-NEXT:       %19 = memref.load %subview[%16, %17, %18] : memref<72x72x72xf64, strided<[5184, 72, 1]>>
