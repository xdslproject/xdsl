"builtin.module"() ({
  ...
  %42 = "arith.addf"(%4#0, %4#1) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
  %43 = "arith.addf"(%6#0, %6#1) <{fastmath = #arith.fastmath<none>}> : (vector<4xf32>, vector<4xf32>) -> vector<4xf32>
  %44 = "arith.subf"(%4#0, %4#1) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
  %45 = "arith.subf"(%6#0, %6#1) <{fastmath = #arith.fastmath<none>}> : (vector<4xf32>, vector<4xf32>) -> vector<4xf32>
  %46 = "arith.mulf"(%4#0, %4#1) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
  %47 = "arith.mulf"(%6#0, %6#1) <{fastmath = #arith.fastmath<none>}> : (vector<4xf32>, vector<4xf32>) -> vector<4xf32>
  %48 = "arith.divf"(%4#0, %4#1) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
  %49 = "arith.divf"(%6#0, %6#1) <{fastmath = #arith.fastmath<none>}> : (vector<4xf32>, vector<4xf32>) -> vector<4xf32>
  %50 = "arith.negf"(%4#0) <{fastmath = #arith.fastmath<none>}> : (f32) -> f32
  %51 = "arith.extf"(%4#0) : (f32) -> f64
  %52 = "arith.extui"(%1#0) : (i32) -> i64
  %53 = "arith.truncf"(%5#0) : (f64) -> f32
  %54 = "arith.trunci"(%2#0) : (i64) -> i32
  %55 = "arith.cmpf"(%4#0, %4#1) <{fastmath = #arith.fastmath<none>, predicate = 2 : i64}> : (f32, f32) -> i1
  %56 = "arith.select"(%0#0, %1#0, %1#1) : (i1, i32, i32) -> i32
  %57 = "arith.select"(%0#0, %4#0, %4#1) : (i1, f32, f32) -> f32
  %58:2 = "arith.addui_extended"(%1#0, %1#1) : (i32, i32) -> (i32, i1)
  %59:2 = "arith.addui_extended"(%2#0, %2#1) : (i64, i64) -> (i64, i1)
}) : () -> ()
