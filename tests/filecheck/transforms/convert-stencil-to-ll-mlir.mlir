...
// CHECK-NEXT:    }
  ...
  func.func @stencil_init_index(%1 : !stencil.field<[0,64]x[0,64]x[0,64]xindex>) {
    %3 = "stencil.apply"() ({
    ^0():
      %x = "stencil.index"() {"dim" = #builtin.int<0>, "offset" = #stencil.index<0, 0, 0>} : () -> index
      %y = "stencil.index"() {"dim" = #builtin.int<1>, "offset" = #stencil.index<0, 0, 0>} : () -> index
      %z = "stencil.index"() {"dim" = #builtin.int<2>, "offset" = #stencil.index<0, 0, 0>} : () -> index
...
// CHECK-NEXT:    }
  ...
  func.func @stencil_init_index_offset(%1 : !stencil.field<[0,64]x[0,64]x[0,64]xindex>) {
    %3 = "stencil.apply"() ({
    ^0():
      %x = "stencil.index"() {"dim" = #builtin.int<0>, "offset" = #stencil.index<1, 1, 1>} : () -> index
      %y = "stencil.index"() {"dim" = #builtin.int<1>, "offset" = #stencil.index<-1, -1, -1>} : () -> index
      %z = "stencil.index"() {"dim" = #builtin.int<2>, "offset" = #stencil.index<0, 0, 0>} : () -> index
      %xy = arith.addi %x, %y : index
      %xyz = arith.addi %xy, %z : index
      "stencil.return"(%xyz) : (index) -> ()
...
func.func @buffered_combine(%2 : !stencil.field<?x?xf64>) {
  ...
  %8 = "stencil.combine"(%4, %6) {"dim" = #builtin.int<0>, "index" = #builtin.int<33>, "operandSegmentSizes" = array<i32: 1, 1, 0, 0>} : (!stencil.temp<[1,33]x[2,66]xf64>, !stencil.temp<[33,65]x[2,66]xf64>) -> !stencil.temp<[1,65]x[2,66]xf64>
