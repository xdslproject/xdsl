// RUN: XDSL_ROUNDTRIP
// RUN: xdsl-opt %s -p stencil-shape-inference | filecheck %s --check-prefix SHAPE
...
// SHAPE-NEXT:        %cst_0 = arith.constant 7.000000e+00 : f64
// SHAPE-NEXT:        %cst_1 = arith.constant 1.200000e+01 : f64
// SHAPE-NEXT:        %13 = arith.divf %cst_0, %cst_1 : f64
// SHAPE-NEXT:        %14 = arith.divf %cst, %cst_1 : f64
...
// SHAPE-NEXT:      }
// SHAPE-NEXT:      %25, %26, %27, %28 = stencil.apply(%arg7_1 = %7 : !stencil.temp<[0,64]x[-3,67]x[0,64]xf64>, %arg8 = %12 : !stencil.temp<[0,64]x[-1,66]x[0,64]xf64>) -> (!stencil.temp<[0,64]x[-1,65]x[0,64]xf64>, !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>, !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>, !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>) {
// SHAPE-NEXT:        %cst_1 = arith.constant 0.000000e+00 : f64
// SHAPE-NEXT:        %cst_0_1 = arith.constant 1.000000e+00 : f64
// SHAPE-NEXT:        %29 = stencil.access %arg8[0, 0, 0] : !stencil.temp<[0,64]x[-1,66]x[0,64]xf64>
// SHAPE-NEXT:        %30 = stencil.access %arg7_1[0, 0, 0] : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>
// SHAPE-NEXT:        %31 = arith.subf %29, %30 : f64
// SHAPE-NEXT:        %32 = stencil.access %arg8[0, 1, 0] : !stencil.temp<[0,64]x[-1,66]x[0,64]xf64>
// SHAPE-NEXT:        %33 = arith.subf %32, %30 : f64
// SHAPE-NEXT:        %34 = arith.addf %31, %33 : f64
// SHAPE-NEXT:        %35 = arith.mulf %31, %33 : f64
// SHAPE-NEXT:        %36 = arith.cmpf olt, %35, %cst_1 : f64
// SHAPE-NEXT:        %37 = arith.select %36, %cst_0_1, %cst_1 : f64
// SHAPE-NEXT:        %38 = stencil.store_result %31 : !stencil.result<f64>
// SHAPE-NEXT:        %39 = stencil.store_result %33 : !stencil.result<f64>
// SHAPE-NEXT:        %40 = stencil.store_result %34 : !stencil.result<f64>
// SHAPE-NEXT:        %41 = stencil.store_result %37 : !stencil.result<f64>
// SHAPE-NEXT:        stencil.return %38, %39, %40, %41 : !stencil.result<f64>, !stencil.result<f64>, !stencil.result<f64>, !stencil.result<f64>
// SHAPE-NEXT:      }
// SHAPE-NEXT:      %42 = stencil.apply(%arg7_2 = %7 : !stencil.temp<[0,64]x[-3,67]x[0,64]xf64>, %arg8_1 = %8 : !stencil.temp<[0,64]x[0,65]x[0,64]xf64>, %arg9 = %25 : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>, %arg10 = %26 : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>, %arg11 = %27 : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>, %arg12 = %28 : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>) -> (!stencil.temp<[0,64]x[0,65]x[0,64]xf64>) {
// SHAPE-NEXT:        %cst_2 = arith.constant 0.000000e+00 : f64
// SHAPE-NEXT:        %cst_0_2 = arith.constant 1.000000e+00 : f64
// SHAPE-NEXT:        %43 = stencil.access %arg12[0, -1, 0] : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>
// SHAPE-NEXT:        %44 = arith.cmpf oeq, %43, %cst_2 : f64
// SHAPE-NEXT:        %45 = arith.select %44, %cst_0_2, %cst_2 : f64
// SHAPE-NEXT:        %46 = stencil.access %arg12[0, 0, 0] : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>
// SHAPE-NEXT:        %47 = arith.mulf %46, %45 : f64
// SHAPE-NEXT:        %48 = arith.addf %43, %47 : f64
// SHAPE-NEXT:        %49 = stencil.access %arg8_1[0, 0, 0] : !stencil.temp<[0,64]x[0,65]x[0,64]xf64>
// SHAPE-NEXT:        %50 = arith.cmpf ogt, %49, %cst_2 : f64
// SHAPE-NEXT:        %51 = "scf.if"(%50) ({
// SHAPE-NEXT:          %52 = stencil.access %arg10[0, -1, 0] : !stencil.temp<[0,64]x[-1,64]x[0,64]xf64>
// SHAPE-NEXT:          %53 = stencil.access %arg11[0, -1, 0] : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>
// SHAPE-NEXT:          %54 = arith.mulf %49, %53 : f64
// SHAPE-NEXT:          %55 = arith.subf %52, %54 : f64
// SHAPE-NEXT:          %56 = arith.subf %cst_0_2, %49 : f64
// SHAPE-NEXT:          %57 = arith.mulf %56, %55 : f64
// SHAPE-NEXT:          scf.yield %57 : f64
// SHAPE-NEXT:        }, {
// SHAPE-NEXT:          %58 = stencil.access %arg9[0, 0, 0] : !stencil.temp<[0,64]x[0,65]x[0,64]xf64>
// SHAPE-NEXT:          %59 = stencil.access %arg11[0, 0, 0] : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>
// SHAPE-NEXT:          %60 = arith.mulf %49, %59 : f64
// SHAPE-NEXT:          %61 = arith.addf %58, %60 : f64
// SHAPE-NEXT:          %62 = arith.addf %cst_0_2, %49 : f64
// SHAPE-NEXT:          %63 = arith.mulf %62, %61 : f64
// SHAPE-NEXT:          scf.yield %63 : f64
// SHAPE-NEXT:        }) : (i1) -> f64
// SHAPE-NEXT:        %64 = arith.mulf %51, %48 : f64
// SHAPE-NEXT:        %65 = "scf.if"(%50) ({
// SHAPE-NEXT:          %66 = stencil.access %arg7_2[0, -1, 0] : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>
// SHAPE-NEXT:          %67 = arith.addf %66, %64 : f64
// SHAPE-NEXT:          scf.yield %67 : f64
// SHAPE-NEXT:        }, {
// SHAPE-NEXT:          %68 = stencil.access %arg7_2[0, 0, 0] : !stencil.temp<[0,64]x[-1,65]x[0,64]xf64>
// SHAPE-NEXT:          %69 = arith.addf %68, %64 : f64
// SHAPE-NEXT:          scf.yield %69 : f64
// SHAPE-NEXT:        }) : (i1) -> f64
// SHAPE-NEXT:        %70 = stencil.store_result %65 : !stencil.result<f64>
// SHAPE-NEXT:        stencil.return %70 : !stencil.result<f64>
// SHAPE-NEXT:      }
// SHAPE-NEXT:      %71 = stencil.apply(%arg7_3 = %10 : !stencil.temp<[0,64]x[0,65]x[0,64]xf64>, %arg8_2 = %42 : !stencil.temp<[0,64]x[0,65]x[0,64]xf64>) -> (!stencil.temp<[0,64]x[0,65]x[0,64]xf64>) {
// SHAPE-NEXT:        %72 = stencil.access %arg7_3[0, 0, 0] : !stencil.temp<[0,64]x[0,65]x[0,64]xf64>
// SHAPE-NEXT:        %73 = stencil.access %arg8_2[0, 0, 0] : !stencil.temp<[0,64]x[0,65]x[0,64]xf64>
// SHAPE-NEXT:        %74 = arith.mulf %72, %73 : f64
// SHAPE-NEXT:        %75 = stencil.store_result %74 : !stencil.result<f64>
// SHAPE-NEXT:        stencil.return %75 : !stencil.result<f64>
// SHAPE-NEXT:      }
// SHAPE-NEXT:      %76 = stencil.apply(%arg7_4 = %7 : !stencil.temp<[0,64]x[-3,67]x[0,64]xf64>, %arg8_3 = %11 : !stencil.temp<[0,64]x[0,64]x[0,64]xf64>, %arg9_1 = %71 : !stencil.temp<[0,64]x[0,65]x[0,64]xf64>, %arg10_1 = %9 : !stencil.temp<[0,64]x[0,64]x[0,64]xf64>) -> (!stencil.temp<[0,64]x[0,64]x[0,64]xf64>) {
// SHAPE-NEXT:        %77 = stencil.access %arg7_4[0, 0, 0] : !stencil.temp<[0,64]x[0,64]x[0,64]xf64>
// SHAPE-NEXT:        %78 = stencil.access %arg8_3[0, 0, 0] : !stencil.temp<[0,64]x[0,64]x[0,64]xf64>
// SHAPE-NEXT:        %79 = arith.mulf %77, %78 : f64
// SHAPE-NEXT:        %80 = stencil.access %arg9_1[0, 0, 0] : !stencil.temp<[0,64]x[0,65]x[0,64]xf64>
// SHAPE-NEXT:        %81 = stencil.access %arg9_1[0, 1, 0] : !stencil.temp<[0,64]x[0,65]x[0,64]xf64>
// SHAPE-NEXT:        %82 = arith.subf %80, %81 : f64
// SHAPE-NEXT:        %83 = arith.addf %79, %82 : f64
// SHAPE-NEXT:        %84 = stencil.access %arg10_1[0, 0, 0] : !stencil.temp<[0,64]x[0,64]x[0,64]xf64>
// SHAPE-NEXT:        %85 = arith.divf %83, %84 : f64
// SHAPE-NEXT:        %86 = stencil.store_result %85 : !stencil.result<f64>
// SHAPE-NEXT:        stencil.return %86 : !stencil.result<f64>
// SHAPE-NEXT:      }
// SHAPE-NEXT:      stencil.store %42 to %6 ([0, 0, 0] : [64, 64, 64]) : !stencil.temp<[0,64]x[0,65]x[0,64]xf64> to !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>
// SHAPE-NEXT:      stencil.store %76 to %5 ([0, 0, 0] : [64, 64, 64]) : !stencil.temp<[0,64]x[0,64]x[0,64]xf64> to !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>
