...
// LIVE-BNAIVE-NEXT:      %4 = riscv.fadd.s %2, %3 : (!riscv.freg<ft11>, !riscv.freg<ft10>) -> !riscv.freg<ft9>
// LIVE-BNAIVE-NEXT:      %5 = riscv.add %0, %1 : (!riscv.reg<t5>, !riscv.reg<t6>) -> !riscv.reg<t4>
