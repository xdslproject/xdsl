...
def get_all_passes() -> dict[str, Callable[[], type[ModulePass]]]:
    ...
    def get_expand_exp_to_polynomials():
        from xdsl.transforms import expand_exp_to_polynomials

        return expand_exp_to_polynomials.ExpToTaylorPass
    ...
    return {
        ...
        "expand-exp-to-polynomials": get_expand_exp_to_polynomials,
