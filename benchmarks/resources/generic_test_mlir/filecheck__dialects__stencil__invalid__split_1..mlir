"builtin.module"() ({
  "func.func"() <{function_type = (!stencil.field<[-4,68]xf64>, !stencil.field<[0,1024]xf64>) -> (), sym_name = "buffered_and_stored_1d"}> ({
  ^bb0(%arg0: !stencil.field<[-4,68]xf64>, %arg1: !stencil.field<[0,1024]xf64>):
    ...
    %2 = "stencil.buffer"(%1) : (!stencil.temp<[0,68]xf64>) -> !stencil.temp<[0,68]xf64>
    "stencil.store"(%1, %arg1) {lb = #stencil.index<[0]>, ub = #stencil.index<[68]>} : (!stencil.temp<[0,68]xf64>, !stencil.field<[0,1024]xf64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
