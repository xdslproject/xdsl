...
"builtin.module"() ({
  ...
  %7 = "llvm.getelementptr"(%6, %0){result_type = i64, rawConstantIndices = array<i32:-2147483648>} : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i32>
...
// CHECK-NEXT:   %7 = "llvm.getelementptr"(%6, %0){result_type = i64, rawConstantIndices = array<i32:-2147483648>} : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i32>
