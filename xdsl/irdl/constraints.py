...
class WithType(Attribute, ABC):
    def get_type(self) -> Attribute: ...


@dataclass(frozen=True)
class WithTypeConstraint(GenericAttrConstraint[AttributeCovT]):
    """
    ...
    def verify(self, attr: Attribute, constraint_context: ConstraintContext) -> None:
        ...
        if not isinstance(attr, WithType):
    ...
    def infer(self, constraint_context: ConstraintContext) -> Attribute:
        ...
        assert isinstance(inferred, WithType)
        self.type_constraint.verify(inferred.get_type(), constraint_context)
        return inferred
