...
riscv_func.func @main() {
    ...
    %3, %4, %5 = riscv.parallel_mov %0, %1, %2 {input_types = [i32, i32, i32]} : (!riscv.reg, !riscv.reg, !riscv.reg) -> (!riscv.reg, !riscv.reg, !riscv.reg)
...
// CHECK-NEXT:      %3, %4, %5 = riscv.parallel_mov %0, %1, %2 {input_types = [i32, i32, i32]} : (!riscv.reg<t0>, !riscv.reg<t1>, !riscv.reg<t2>) -> (!riscv.reg<t0>, !riscv.reg<t1>, !riscv.reg<t2>)
