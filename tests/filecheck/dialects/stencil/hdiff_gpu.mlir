...
func.func @stencil_hdiff(%0 : !stencil.field<?x?x?xf64>, %1 : !stencil.field<?x?x?xf64>) {
  ...
  %4 = "stencil.load"(%2) : (!stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>) -> !stencil.temp<?x?x?xf64>
  %5 = "stencil.apply"(%4) ({
  ^0(%6 : !stencil.temp<?x?x?xf64>):
    ...
    "stencil.return"(%16, %16, %16, %16) <{"unroll" = #stencil.index<2, 2, 1>}> : (f64, f64, f64, f64) -> ()
...
// CHECK:         func.func @stencil_hdiff(%0 : memref<?x?x?xf64>, %1 : memref<?x?x?xf64>) {
