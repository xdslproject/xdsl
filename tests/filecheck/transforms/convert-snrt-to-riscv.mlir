...
// CHECK-NEXT:   %cluster_idx_3 = riscv.li 0 : () -> !riscv.reg<>
// CHECK-NEXT:   %cluster_idx_4 = riscv.sub %cluster_idx_2, %cluster_idx_3 : (!riscv.reg<>, !riscv.reg<>) -> !riscv.reg<>
// CHECK-NEXT:   %cluster_idx_5 = builtin.unrealized_conversion_cast %cluster_idx_4 : !riscv.reg<> to i32
