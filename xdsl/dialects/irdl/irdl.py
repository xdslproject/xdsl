...
class DialectOp(IRDLOperation):
    ...
    traits = OpTraits({NoTerminator(), SymbolOpInterface(), SymbolTable()})
...
class TypeOp(IRDLOperation):
    ...
    traits = OpTraits({NoTerminator(), HasParent(DialectOp), SymbolOpInterface()})
...
class ParametersOp(IRDLOperation):
    ...
    traits = OpTraits({HasParent(TypeOp, AttributeOp)})
...
class OperandsOp(IRDLOperation):
    ...
    traits = OpTraits({HasParent(OperationOp)})
