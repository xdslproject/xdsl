...
def asm_html(asm: str) -> mo.Html:
    ...
    """
    return mo.ui.code_editor(asm, language="python", disabled=True)  # pyright: ignore[reportPrivateImportUsage]
...
def module_html(module: ModuleOp) -> mo.Html:
    ...
    """
    return mo.ui.code_editor(str(module), language="javascript", disabled=True)  # pyright: ignore[reportPrivateImportUsage]
