...
from xdsl.transforms.riscv_register_allocation import RegisterAllocatorJRegs
from xdsl.riscv_asm_writer import riscv_code

from ..compiler import run_riscv

from ..emulator.emulator_iop import RV_Debug
...
def test_simple():
    ...
    RegisterAllocatorJRegs().allocate_registers(module)
