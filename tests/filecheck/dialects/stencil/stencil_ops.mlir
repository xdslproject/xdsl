...
builtin.module {
  func.func private @myfunc(%data : memref<2xmemref<?x?x?xf32>>)  attributes {"param_names" = ["data"]}{
    ...
    ^0(%time : index):
      ...
      %2 = arith.addi %time_1, %1 : i64
      %t0 = arith.remsi %2, %0 : i64
      %3 = "arith.constant"() {"value" = 1 : i64} : () -> i64
      %4 = arith.addi %time_1, %3 : i64
      %t1 = arith.remsi %4, %0 : i64
...
// CHECK:      builtin.module {
// CHECK-NEXT:   func.func private @myfunc(%data : memref<2xmemref<?x?x?xf32>>)  attributes {"param_names" = ["data"]}{
...
// CHECK-NEXT:       %2 = arith.addi %time_1, %1 : i64
// CHECK-NEXT:       %t0 = arith.remsi %2, %0 : i64
// CHECK-NEXT:       %3 = "arith.constant"() {"value" = 1 : i64} : () -> i64
// CHECK-NEXT:       %4 = arith.addi %time_1, %3 : i64
// CHECK-NEXT:       %t1 = arith.remsi %4, %0 : i64
...
// CHECK-NEXT:       ^1(%t0_buff : !stencil.temp<?xf32>):
