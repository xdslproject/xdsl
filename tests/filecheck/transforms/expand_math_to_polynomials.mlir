...
// CHECK:      func.func @test_terms5(%[[X:.*]]: f64) -> f64 {
// CHECK-NEXT:   %[[RES0:.*]] = arith.constant 1.000000e+00 : f64
// CHECK-NEXT:   %[[TERM0:.*]] = arith.constant 1.000000e+00 : f64
// CHECK-NEXT:   %[[I1:.*]] = arith.constant 1.000000e+00 : f64
// CHECK-NEXT:   %[[FRAC1:.*]] = arith.mulf %[[X]], %[[I1]] : f64
...
// CHECK-NEXT:   %[[TERM3:.*]] = arith.mulf %[[FRAC3]], %[[TERM2]] : f64
// CHECK-NEXT:   %[[RES3:.*]] = arith.addf %[[RES2]], %[[TERM3]] : f64
// CHECK-NEXT:   %[[I4:.*]] = arith.constant 2.500000e-01 : f64
// CHECK-NEXT:   %[[FRAC4:.*]] = arith.mulf %[[X]], %[[I4]] : f64
// CHECK-NEXT:   %[[TERM4:.*]] = arith.mulf %[[FRAC4]], %[[TERM3]] : f64
// CHECK-NEXT:   %[[RES4:.*]] = arith.addf %[[RES3]], %[[TERM4]] : f64
// CHECK-NEXT:   func.return %[[RES4]] : f64
// CHECK-NEXT: }

// CHECK:      func.func @test_terms5_f32(%[[X32:.*]]: f32) -> f32 {
// CHECK-NEXT:   %[[RES0_32:.*]] = arith.constant 1.000000e+00 : f32
// CHECK-NEXT:   %[[TERM0_32:.*]] = arith.constant 1.000000e+00 : f32
// CHECK-NEXT:   %[[I1_32:.*]] = arith.constant 1.000000e+00 : f32
// CHECK-NEXT:   %[[FRAC1_32:.*]] = arith.mulf %[[X32]], %[[I1_32]] : f32
...
// CHECK-NEXT:   %[[TERM3_32:.*]] = arith.mulf %[[FRAC3_32]], %[[TERM2_32]] : f32
// CHECK-NEXT:   %[[RES3_32:.*]] = arith.addf %[[RES2_32]], %[[TERM3_32]] : f32
// CHECK-NEXT:   %[[I4_32:.*]] = arith.constant 2.500000e-01 : f32
// CHECK-NEXT:   %[[FRAC4_32:.*]] = arith.mulf %[[X32]], %[[I4_32]] : f32
// CHECK-NEXT:   %[[TERM4_32:.*]] = arith.mulf %[[FRAC4_32]], %[[TERM3_32]] : f32
// CHECK-NEXT:   %[[RES4_32:.*]] = arith.addf %[[RES3_32]], %[[TERM4_32]] : f32
// CHECK-NEXT:   func.return %[[RES4_32]] : f32
// CHECK-NEXT: }

// CHECK:      func.func @test_terms5_vec(%[[XV:.*]]: vector<2xf32>) -> vector<2xf32> {
// CHECK-NEXT:   %[[RES0_V:.*]] = arith.constant dense<1.000000e+00> : vector<2xf32>
// CHECK-NEXT:   %[[TERM0_V:.*]] = arith.constant dense<1.000000e+00> : vector<2xf32>
// CHECK-NEXT:   %[[I1_V:.*]] = arith.constant dense<1.000000e+00> : vector<2xf32>
// CHECK-NEXT:   %[[FRAC1_V:.*]] = arith.mulf %[[XV]], %[[I1_V]] : vector<2xf32>
...
// CHECK-NEXT:   %[[TERM3_V:.*]] = arith.mulf %[[FRAC3_V]], %[[TERM2_V]] : vector<2xf32>
// CHECK-NEXT:   %[[RES3_V:.*]] = arith.addf %[[RES2_V]], %[[TERM3_V]] : vector<2xf32>
// CHECK-NEXT:   %[[I4_V:.*]] = arith.constant dense<2.500000e-01> : vector<2xf32>
// CHECK-NEXT:   %[[FRAC4_V:.*]] = arith.mulf %[[XV]], %[[I4_V]] : vector<2xf32>
// CHECK-NEXT:   %[[TERM4_V:.*]] = arith.mulf %[[FRAC4_V]], %[[TERM3_V]] : vector<2xf32>
// CHECK-NEXT:   %[[RES4_V:.*]] = arith.addf %[[RES3_V]], %[[TERM4_V]] : vector<2xf32>
// CHECK-NEXT:   func.return %[[RES4_V]] : vector<2xf32>
// CHECK-NEXT: }

// ----- pass-level terms=5 applied to plain math.exp (no op attribute) -----
