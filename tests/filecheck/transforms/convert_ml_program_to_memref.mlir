...
// CHECK:       module {
// CHECK-NEXT:    ml_program.global private @global_same_type(dense<4> : memref<4xi32>) : memref<4xi32>
// CHECK-NEXT:    %global_same_type = ml_program.global_load_const @global_same_type : memref<4xi32>
// CHECK-NEXT:  }
