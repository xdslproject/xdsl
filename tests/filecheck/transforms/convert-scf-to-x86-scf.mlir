...
//  CHECK-NEXT:      %zero_outer_1 = builtin.unrealized_conversion_cast %zero_outer : index to !x86.reg64
//  CHECK-NEXT:      %forty_outer_1 = builtin.unrealized_conversion_cast %forty_outer : index to !x86.reg64
//  CHECK-NEXT:      %step_outer_1 = builtin.unrealized_conversion_cast %step_outer : index to !x86.reg64
//  CHECK-NEXT:      x86_scf.for %offset_outer : !x86.reg64  = %zero_outer_1 to %forty_outer_1 step %step_outer_1 {
//  CHECK-NEXT:        %offset_outer_1 = builtin.unrealized_conversion_cast %offset_outer : !x86.reg64 to index
...
//  CHECK-NEXT:        %zero_inner_1 = builtin.unrealized_conversion_cast %zero_inner : index to !x86.reg64
//  CHECK-NEXT:        %forty_inner_1 = builtin.unrealized_conversion_cast %forty_inner : index to !x86.reg64
//  CHECK-NEXT:        %step_inner_1 = builtin.unrealized_conversion_cast %step_inner : index to !x86.reg64
//  CHECK-NEXT:        x86_scf.for %offset_inner : !x86.reg64  = %zero_inner_1 to %forty_inner_1 step %step_inner_1 {
//  CHECK-NEXT:          %offset_inner_1 = builtin.unrealized_conversion_cast %offset_inner : !x86.reg64 to index
