...
// CHECK-NEXT:     %fabin_dsd = "csl.get_fab_dsd"(%col_1, %scalar) : (!csl.color, i32) -> !csl<dsd fabin_dsd>
// CHECK-NEXT:     %fabout_dsd = "csl.get_fab_dsd"(%col_1, %scalar) <{"control" = true, "wavelet_index_offset" = false}> : (!csl.color, i32) -> !csl<dsd fabout_dsd>
