...
ctx1.register_literal(int, lambda v: bigint.ConstantOp(v))
...
ctx2.register_literal(bool, lambda v: arith.ConstantOp(builtin.IntegerAttr(int(v), 1)))
ctx2.register_literal(int, lambda v: bigint.ConstantOp(v))
ctx2.register_literal(float, lambda v: arith.ConstantOp(builtin.FloatAttr(v, 64)))
