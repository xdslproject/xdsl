...
if __name__ == "__main__":
    ...
    profile(
        {
            "Lexer.empty_program": BenchmarkFunction(LEXER.time_empty_program),
            "Lexer.constant_100": BenchmarkFunction(LEXER.time_constant_100),
            "Lexer.constant_1000": BenchmarkFunction(LEXER.time_constant_1000),
            "Lexer.dense_attr": BenchmarkFunction(LEXER.ignore_time_dense_attr),
            "Lexer.dense_attr_hex": BenchmarkFunction(LEXER.ignore_time_dense_attr_hex),
        }
    )
