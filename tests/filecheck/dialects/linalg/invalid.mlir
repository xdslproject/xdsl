...
%1, %2, %3, %4 = "test.op"() : () -> (memref<4x6xf32>, memref<6x4xf32>, memref<4x4xf32>, memref<4x4xf32>)
linalg.matmul ins(%1, %2, %3 : memref<4x6xf32>, memref<6x4xf32>, memref<4x4xf32>) outs(%4 : memref<4x4xf32>)

// CHECK: Operation does not verify: Operation has 4 operands but 3 indexing maps

// -----

%1, %2, %3 = "test.op"() : () -> (memref<1x4x8x8xf32>, memref<6x4x3x3xf32>, memref<1x9x6x6xf32>)
linalg.conv_2d_nchw_fchw {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>} ins(%1, %2 : memref<1x4x8x8xf32>, memref<6x4x3x3xf32>) outs(%3 : memref<1x9x6x6xf32>)

// CHECK: Operation does not verify: dim(operand 2, 1) = 9 doesn't match the 6 given by its indexing map
