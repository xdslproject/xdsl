...
builtin.module {
  func.func private @stencil_buffer(%0 : !stencil.field<[-4,68]xf64>, %1 : !stencil.field<[-4,68]xf64>) {
    ...
    %2 = "stencil.combine"(%15, %12) {dim=0 : index, index=11 : index, operandSegmentSizes = array<i32:1,1,0,0>} : (!stencil.temp<?xf64>, !stencil.temp<?xf64>) -> !stencil.temp<?xf64>
...
// CHECK-NEXT:      }
// CHECK-NEXT:      %6 = stencil.buffer %3 : !stencil.temp<?xf64>
// CHECK-NEXT:      %7 = stencil.apply(%8 = %6 : !stencil.temp<?xf64>) -> (!stencil.temp<?xf64>) {
// CHECK-NEXT:        %9 = stencil.access %8 [0] : !stencil.temp<?xf64>
// CHECK-NEXT:        stencil.return %9 : f64
// CHECK-NEXT:      }
// CHECK-NEXT:      %10 = stencil.combine 0 at 11 lower = (%6 : !stencil.temp<?xf64>) upper = (%7 : !stencil.temp<?xf64>) : !stencil.temp<?xf64>
// CHECK-NEXT:      stencil.store %10 to %1 ([0] : [64]) : !stencil.temp<?xf64> to !stencil.field<[-4,68]xf64>
// CHECK-NEXT:      func.return
// CHECK-NEXT:    }
...
builtin.module {
  func.func private @stencil_offset_mapping(%0 : !stencil.field<?x?xf64>, %1 : !stencil.field<?x?xf64>) {
    ...
    %5 = "stencil.apply"(%4) ({
    ^0(%6 : !stencil.temp<[-1,65]x[-1,65]xf64>):
      %7 = "stencil.access"(%6) {"offset" = #stencil.index<-1, 0>, "offset_mapping" = #stencil.index<0, 1>} : (!stencil.temp<[-1,65]x[-1,65]xf64>) -> f64
...
// CHECK-NEXT:      %4 = stencil.load %2 : !stencil.field<[-4,68]x[-4,68]xf64> -> !stencil.temp<[-1,65]x[-1,65]xf64>
// CHECK-NEXT:      %5 = stencil.apply(%6 = %4 : !stencil.temp<[-1,65]x[-1,65]xf64>) -> (!stencil.temp<[0,64]x[0,64]xf64>) {
// CHECK-NEXT:        %7 = stencil.access %6 [-1, 0] attributes {"offset_mapping" =  #stencil.index<0, 1>} : !stencil.temp<[-1,65]x[-1,65]xf64>
...
builtin.module {
  func.func private @stencil_dyn_access(%0 : !stencil.field<?x?xf64>, %1 : !stencil.field<?x?xf64>) {
    ...
    %5 = "stencil.apply"(%4) ({
    ^0(%6 : !stencil.temp<[-1,65]x[-1,65]xf64>):
      %i = "stencil.index"() {"dim" = 0 : index, "offset" = #stencil.index[-1, -1]} : () -> index
      %j = "stencil.index"() {"dim" = 1 : index, "offset" = #stencil.index[1, 1]} : () -> index
