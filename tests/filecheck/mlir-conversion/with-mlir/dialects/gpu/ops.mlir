// RUN: xdsl-opt %s --print-op-generic | $XDSL_MLIR_OPT --mlir-print-op-generic | xdsl-opt --print-op-generic | filecheck %s
...
// CHECK-NEXT:             %{{.*}} = "memref.alloc"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<10x10xi32>
