...
def get_all_passes() -> dict[str, Callable[[], type[ModulePass]]]:
    ...
    def get_convert_exp_to_taylor():
        from xdsl.transforms import convert_exp_to_taylor

        return convert_exp_to_taylor.ExpToTaylorPass
    ...
    return {
        ...
        "convert-exp-to-taylor": get_convert_exp_to_taylor,
