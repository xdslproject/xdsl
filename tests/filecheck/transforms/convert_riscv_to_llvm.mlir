...
%4 = riscv.csrrs %0, 3860, "r" : (!riscv.reg<zero>) -> !riscv.reg<>
...
%5 = riscv.csrrs %0, 1986 : (!riscv.reg<zero>) -> !riscv.reg<zero>
...
%6 = riscv.csrrci 1984, 1 : () -> !riscv.reg<>
...
// CHECK-NEXT: "llvm.inline_asm"(%17, %18) <{"asm_string" = ".insn i 0x2b, 0, 0, x0, $0, $1", "constraints" = "r,r", "asm_dialect" = 0 : i64}> : (i32, i32) -> ()
...
// CHECK-NEXT: "llvm.inline_asm"(%19, %20) <{"asm_string" = ".insn i 0x2b, 0, 1, x0, $0, $1", "constraints" = "r,r", "asm_dialect" = 0 : i64}> : (i32, i32) -> ()
...
// CHECK-NEXT: "llvm.inline_asm"(%21, %22) <{"asm_string" = ".insn i 0x2b, 0, 6, x0, $0, $1", "constraints" = "r,r", "asm_dialect" = 0 : i64}> : (i32, i32) -> ()

riscv_snitch.dmrep %1 : (!riscv.reg<>) -> ()
// CHECK-NEXT: %23 = builtin.unrealized_conversion_cast %2 : !riscv.reg<> to i32
// CHECK-NEXT: "llvm.inline_asm"(%23) <{"asm_string" = ".insn i 0x2b, 0, 7, x0, $0, x0", "constraints" = "r", "asm_dialect" = 0 : i64}> : (i32) -> ()

%7 = riscv_snitch.dmcpyi %1, 2 : (!riscv.reg<>) -> !riscv.reg<>
// CHECK-NEXT: %24 = builtin.unrealized_conversion_cast %2 : !riscv.reg<> to i32
// CHECK-NEXT: %25 = "llvm.inline_asm"(%24) <{"asm_string" = ".insn i 0x2b, 0, 2, $0, $1, 2", "constraints" = "=r,r", "asm_dialect" = 0 : i64}> : (i32) -> i32
