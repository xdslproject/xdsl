// RUN: xdsl-opt %s --allow-unregistered-dialect | $XDSL_MLIR_OPT --allow-unregistered-dialect --mlir-print-local-scope -mlir-print-op-generic | xdsl-opt --allow-unregistered-dialect
