...
// CHECK-NEXT:   pdl_interp.is_not_null %1 : !pdl.value -> ^bb1, ^bb2
// CHECK-NEXT: ^bb1:
// CHECK-NEXT:   %2 = ematch.get_class_result %1
// CHECK-NEXT:   pdl_interp.is_not_null %2 : !pdl.value -> ^bb3, ^bb2
// CHECK-NEXT: ^bb2:
// CHECK-NEXT:   pdl_interp.finalize
// CHECK-NEXT: ^bb3:
// CHECK-NEXT:   pdl_interp.switch_operation_name of %0 to ["arith.divui", "arith.muli"](^bb4, ^bb11) -> ^bb2
// CHECK-NEXT: ^bb4:
// CHECK-NEXT:   pdl_interp.check_operand_count of %0 is 2 -> ^bb5, ^bb2
// CHECK-NEXT: ^bb5:
// CHECK-NEXT:   pdl_interp.check_result_count of %0 is 1 -> ^bb6, ^bb2
// CHECK-NEXT: ^bb6:
// CHECK-NEXT:   %3 = pdl_interp.get_operand 0 of %0
// CHECK-NEXT:   pdl_interp.is_not_null %3 : !pdl.value -> ^bb7, ^bb2
// CHECK-NEXT: ^bb7:
...
// CHECK-NEXT:     pdl_interp.is_not_null %9 : !pdl.operation -> ^bb2, ^bb1
// CHECK-NEXT:   ^bb1:
// CHECK-NEXT:     pdl_interp.continue
// CHECK-NEXT:   ^bb2:
// CHECK-NEXT:     pdl_interp.check_operation_name of %9 is "arith.muli" -> ^bb3, ^bb1
// CHECK-NEXT:   ^bb3:
// CHECK-NEXT:     pdl_interp.check_operand_count of %9 is 2 -> ^bb4, ^bb1
// CHECK-NEXT:   ^bb4:
// CHECK-NEXT:     pdl_interp.check_result_count of %9 is 1 -> ^bb5, ^bb1
// CHECK-NEXT:   ^bb5:
// CHECK-NEXT:     %10 = pdl_interp.get_operand 0 of %9
// CHECK-NEXT:     pdl_interp.is_not_null %10 : !pdl.value -> ^bb6, ^bb1
// CHECK-NEXT:   ^bb6:
// CHECK-NEXT:     %11 = pdl_interp.get_operand 1 of %9
// CHECK-NEXT:     pdl_interp.is_not_null %11 : !pdl.value -> ^bb7, ^bb1
// CHECK-NEXT:   ^bb7:
// CHECK-NEXT:     %12 = pdl_interp.get_result 0 of %9
// CHECK-NEXT:     pdl_interp.is_not_null %12 : !pdl.value -> ^bb8, ^bb1
// CHECK-NEXT:   ^bb8:
...
// CHECK-NEXT:     pdl_interp.are_equal %14, %15 : !pdl.type -> ^bb11, ^bb1
// CHECK-NEXT:   ^bb11:
...
// CHECK-NEXT:     pdl_interp.record_match @rewriters::@pdl_generated_rewriter_0(%16, %17, %14, %18, %0 : !pdl.value, !pdl.value, !pdl.type, !pdl.value, !pdl.operation) : benefit(1), loc([]), root("arith.divui") -> ^bb1
// CHECK-NEXT:   } -> ^bb8
// CHECK-NEXT: ^bb11:
// CHECK-NEXT:   pdl_interp.check_operand_count of %0 is 2 -> ^bb12, ^bb2
// CHECK-NEXT: ^bb12:
// CHECK-NEXT:   pdl_interp.check_result_count of %0 is 1 -> ^bb13, ^bb2
// CHECK-NEXT: ^bb13:
// CHECK-NEXT:   %19 = pdl_interp.get_operand 0 of %0
// CHECK-NEXT:   pdl_interp.is_not_null %19 : !pdl.value -> ^bb14, ^bb2
// CHECK-NEXT: ^bb14:
// CHECK-NEXT:   %20 = pdl_interp.get_operand 1 of %0
// CHECK-NEXT:   pdl_interp.is_not_null %20 : !pdl.value -> ^bb15, ^bb2
// CHECK-NEXT: ^bb15:
...
// CHECK-NEXT:     pdl_interp.is_not_null %23 : !pdl.operation -> ^bb2, ^bb1
// CHECK-NEXT:   ^bb1:
// CHECK-NEXT:     pdl_interp.continue
// CHECK-NEXT:   ^bb2:
// CHECK-NEXT:     pdl_interp.switch_operation_name of %23 to ["arith.divui", "arith.constant"](^bb3, ^bb12) -> ^bb1
// CHECK-NEXT:   ^bb3:
// CHECK-NEXT:     pdl_interp.check_operand_count of %23 is 2 -> ^bb4, ^bb1
// CHECK-NEXT:   ^bb4:
// CHECK-NEXT:     pdl_interp.check_result_count of %23 is 1 -> ^bb5, ^bb1
// CHECK-NEXT:   ^bb5:
// CHECK-NEXT:     %24 = pdl_interp.get_result 0 of %23
// CHECK-NEXT:     pdl_interp.is_not_null %24 : !pdl.value -> ^bb6, ^bb1
// CHECK-NEXT:   ^bb6:
...
// CHECK-NEXT:     pdl_interp.are_equal %26, %27 : !pdl.type -> ^bb9, ^bb1
// CHECK-NEXT:   ^bb9:
// CHECK-NEXT:     %28 = pdl_interp.get_operand 0 of %23
// CHECK-NEXT:     pdl_interp.is_not_null %28 : !pdl.value -> ^bb10, ^bb1
// CHECK-NEXT:   ^bb10:
// CHECK-NEXT:     %29 = pdl_interp.get_operand 1 of %23
// CHECK-NEXT:     pdl_interp.is_not_null %29 : !pdl.value -> ^bb11, ^bb1
// CHECK-NEXT:   ^bb11:
...
// CHECK-NEXT:     pdl_interp.record_match @rewriters::@pdl_generated_rewriter_1(%30, %31, %26, %32, %0 : !pdl.value, !pdl.value, !pdl.type, !pdl.value, !pdl.operation) : benefit(1), loc([]), root("arith.muli") -> ^bb1
// CHECK-NEXT:   ^bb12:
// CHECK-NEXT:     pdl_interp.check_operand_count of %23 is 0 -> ^bb13, ^bb1
// CHECK-NEXT:   ^bb13:
// CHECK-NEXT:     pdl_interp.check_result_count of %23 is 1 -> ^bb14, ^bb1
// CHECK-NEXT:   ^bb14:
// CHECK-NEXT:     %33 = pdl_interp.get_result 0 of %23
// CHECK-NEXT:     pdl_interp.is_not_null %33 : !pdl.value -> ^bb15, ^bb1
// CHECK-NEXT:   ^bb15:
...
// CHECK-NEXT:     pdl_interp.are_equal %35, %36 : !pdl.type -> ^bb18, ^bb1
// CHECK-NEXT:   ^bb18:
// CHECK-NEXT:     %37 = pdl_interp.get_attribute "value" of %23
// CHECK-NEXT:     pdl_interp.is_not_null %37 : !pdl.attribute -> ^bb19, ^bb1
// CHECK-NEXT:   ^bb19:
// CHECK-NEXT:     pdl_interp.check_attribute %37 is 1 : i32 -> ^bb20, ^bb1
// CHECK-NEXT:   ^bb20:
// CHECK-NEXT:     %38 = ematch.get_class_representative %19
// CHECK-NEXT:     pdl_interp.record_match @rewriters::@pdl_generated_rewriter_2(%38, %0 : !pdl.value, !pdl.operation) : benefit(1), loc([]), root("arith.muli") -> ^bb1
// CHECK-NEXT:   } -> ^bb2
// CHECK-NEXT: }
...
// NOOPT-NEXT:   pdl_interp.is_not_null %1 : !pdl.value -> ^bb2, ^bb1
// NOOPT-NEXT: ^bb1:
// NOOPT-NEXT:   pdl_interp.finalize
// NOOPT-NEXT: ^bb2:
// NOOPT-NEXT:   pdl_interp.switch_operation_name of %0 to ["arith.divui", "arith.muli"](^bb3, ^bb19) -> ^bb1
// NOOPT-NEXT: ^bb3:
...
// NOOPT-NEXT:   pdl_interp.is_not_null %3 : !pdl.value -> ^bb9, ^bb7
// NOOPT-NEXT: ^bb7:
// NOOPT-NEXT:   %4 = pdl_interp.get_operand 1 of %0
// NOOPT-NEXT:   pdl_interp.are_equal %2, %4 : !pdl.value -> ^bb8, ^bb1
// NOOPT-NEXT: ^bb8:
...
// NOOPT-NEXT:   pdl_interp.is_not_null %6 : !pdl.operation -> ^bb10, ^bb7
// NOOPT-NEXT: ^bb10:
// NOOPT-NEXT:   pdl_interp.check_operation_name of %6 is "arith.muli" -> ^bb11, ^bb7
// NOOPT-NEXT: ^bb11:
// NOOPT-NEXT:   pdl_interp.check_operand_count of %6 is 2 -> ^bb12, ^bb7
// NOOPT-NEXT: ^bb12:
// NOOPT-NEXT:   pdl_interp.check_result_count of %6 is 1 -> ^bb13, ^bb7
// NOOPT-NEXT: ^bb13:
// NOOPT-NEXT:   %7 = pdl_interp.get_operand 0 of %6
// NOOPT-NEXT:   pdl_interp.is_not_null %7 : !pdl.value -> ^bb14, ^bb7
// NOOPT-NEXT: ^bb14:
// NOOPT-NEXT:   %8 = pdl_interp.get_operand 1 of %6
// NOOPT-NEXT:   pdl_interp.is_not_null %8 : !pdl.value -> ^bb15, ^bb7
// NOOPT-NEXT: ^bb15:
// NOOPT-NEXT:   %9 = pdl_interp.get_result 0 of %6
// NOOPT-NEXT:   pdl_interp.is_not_null %9 : !pdl.value -> ^bb16, ^bb7
// NOOPT-NEXT: ^bb16:
// NOOPT-NEXT:   pdl_interp.are_equal %9, %2 : !pdl.value -> ^bb17, ^bb7
// NOOPT-NEXT: ^bb17:
// NOOPT-NEXT:   %10 = pdl_interp.get_value_type of %9 : !pdl.type
// NOOPT-NEXT:   %11 = pdl_interp.get_value_type of %1 : !pdl.type
// NOOPT-NEXT:   pdl_interp.are_equal %10, %11 : !pdl.type -> ^bb18, ^bb7
// NOOPT-NEXT: ^bb18:
// NOOPT-NEXT:   pdl_interp.record_match @rewriters::@pdl_generated_rewriter_0(%8, %3, %10, %7, %0 : !pdl.value, !pdl.value, !pdl.type, !pdl.value, !pdl.operation) : benefit(1), loc([]), root("arith.divui") -> ^bb7
// NOOPT-NEXT: ^bb19:
// NOOPT-NEXT:   pdl_interp.check_operand_count of %0 is 2 -> ^bb20, ^bb1
// NOOPT-NEXT: ^bb20:
// NOOPT-NEXT:   pdl_interp.check_result_count of %0 is 1 -> ^bb21, ^bb1
// NOOPT-NEXT: ^bb21:
// NOOPT-NEXT:   %12 = pdl_interp.get_operand 0 of %0
// NOOPT-NEXT:   pdl_interp.is_not_null %12 : !pdl.value -> ^bb22, ^bb1
// NOOPT-NEXT: ^bb22:
...
// NOOPT-NEXT: ^bb23:
// NOOPT-NEXT:   pdl_interp.is_not_null %13 : !pdl.value -> ^bb24, ^bb1
// NOOPT-NEXT: ^bb24:
// NOOPT-NEXT:   pdl_interp.switch_operation_name of %14 to ["arith.divui", "arith.constant"](^bb25, ^bb33) -> ^bb1
// NOOPT-NEXT: ^bb25:
...
// NOOPT-NEXT: ^bb33:
// NOOPT-NEXT:   pdl_interp.check_operand_count of %14 is 0 -> ^bb34, ^bb1
// NOOPT-NEXT: ^bb34:
// NOOPT-NEXT:   pdl_interp.check_result_count of %14 is 1 -> ^bb35, ^bb1
// NOOPT-NEXT: ^bb35:
// NOOPT-NEXT:   %20 = pdl_interp.get_result 0 of %14
// NOOPT-NEXT:   pdl_interp.is_not_null %20 : !pdl.value -> ^bb36, ^bb1
// NOOPT-NEXT: ^bb36:
// NOOPT-NEXT:   pdl_interp.are_equal %20, %13 : !pdl.value -> ^bb37, ^bb1
// NOOPT-NEXT: ^bb37:
// NOOPT-NEXT:   %21 = pdl_interp.get_value_type of %20 : !pdl.type
// NOOPT-NEXT:   %22 = pdl_interp.get_value_type of %1 : !pdl.type
// NOOPT-NEXT:   pdl_interp.are_equal %21, %22 : !pdl.type -> ^bb38, ^bb1
// NOOPT-NEXT: ^bb38:
// NOOPT-NEXT:   %23 = pdl_interp.get_attribute "value" of %14
// NOOPT-NEXT:   pdl_interp.is_not_null %23 : !pdl.attribute -> ^bb39, ^bb1
// NOOPT-NEXT: ^bb39:
// NOOPT-NEXT:   pdl_interp.check_attribute %23 is 1 : i32 -> ^bb40, ^bb1
// NOOPT-NEXT: ^bb40:
