...
def _(TypedPtr, a_shape, b_shape, c_shape, mo, riscv_ctx, riscv_module):
    ...
    register_implementations(riscv_interpreter, riscv_ctx, include_wgpu=False)
...
def _(
    ...
    register_implementations(snitch_interpreter, snitch_stream_ctx, include_wgpu=False)
