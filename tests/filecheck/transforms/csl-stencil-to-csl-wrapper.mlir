...
// CHECK-NEXT: }, {
// CHECK-NEXT: ^bb0(%24: i16, %25: i16, %26: i16, %27: i16, %28: i16, %29: i16, %30: i16, %memcpy_params: !csl.comptime_struct, %stencil_comms_params: !csl.comptime_struct, %isBorderRegionPE: i1):
...
// CHECK-NEXT:     ^bb0(%41: tensor<4x255xf32>, %42: index, %43: tensor<510xf32>, %44: memref<255xf32>):
...
// CHECK-NEXT: ^bb0(%41: i16, %42: i16, %43: i16, %44: i16, %45: i16, %46: i16, %47: i16, %48: i16, %49: i16):
...
// CHECK-NEXT: }, {
// CHECK-NEXT: ^bb0(%65: i16, %66: i16, %67: i16, %68: i16, %69: i16, %70: i16, %71: i16, %memcpy_params_1: !csl.comptime_struct, %stencil_comms_params_1: !csl.comptime_struct, %isBorderRegionPE_1: i1):
