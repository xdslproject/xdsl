...
// CHECK-NEXT:   %8 = tosa.mul %0, %0, %s : (tensor<12x34xi32>, tensor<12x34xi32>, tensor<1xi8>) -> tensor<12x34xi32>
// CHECK-NEXT:   %9 = tosa.mul %0, %1, %s : (tensor<12x34xi32>, tensor<1x1xi32>, tensor<1xi8>) -> tensor<12x34xi32>
