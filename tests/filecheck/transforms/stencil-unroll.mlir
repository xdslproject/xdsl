...
// CHECK-NEXT:        %130 = "stencil.index"() {"dim" = 0 : index, "offset" = #stencil.index<0, 0, 0>} : () -> index
// CHECK-NEXT:        %131 = "stencil.index"() {"dim" = 1 : index, "offset" = #stencil.index<0, 0, 0>} : () -> index
// CHECK-NEXT:        %132 = "stencil.index"() {"dim" = 2 : index, "offset" = #stencil.index<0, 0, 0>} : () -> index
...
// CHECK-NEXT:        %135 = "stencil.index"() {"dim" = 0 : index, "offset" = #stencil.index<0, 1, 0>} : () -> index
// CHECK-NEXT:        %136 = "stencil.index"() {"dim" = 1 : index, "offset" = #stencil.index<0, 1, 0>} : () -> index
// CHECK-NEXT:        %137 = "stencil.index"() {"dim" = 2 : index, "offset" = #stencil.index<0, 1, 0>} : () -> index
...
// CHECK-NEXT:        %140 = "stencil.index"() {"dim" = 0 : index, "offset" = #stencil.index<0, 2, 0>} : () -> index
// CHECK-NEXT:        %141 = "stencil.index"() {"dim" = 1 : index, "offset" = #stencil.index<0, 2, 0>} : () -> index
// CHECK-NEXT:        %142 = "stencil.index"() {"dim" = 2 : index, "offset" = #stencil.index<0, 2, 0>} : () -> index
...
// CHECK-NEXT:        %145 = "stencil.index"() {"dim" = 0 : index, "offset" = #stencil.index<0, 3, 0>} : () -> index
// CHECK-NEXT:        %146 = "stencil.index"() {"dim" = 1 : index, "offset" = #stencil.index<0, 3, 0>} : () -> index
// CHECK-NEXT:        %147 = "stencil.index"() {"dim" = 2 : index, "offset" = #stencil.index<0, 3, 0>} : () -> index
...
// CHECK-NEXT:        %150 = "stencil.index"() {"dim" = 0 : index, "offset" = #stencil.index<0, 4, 0>} : () -> index
// CHECK-NEXT:        %151 = "stencil.index"() {"dim" = 1 : index, "offset" = #stencil.index<0, 4, 0>} : () -> index
// CHECK-NEXT:        %152 = "stencil.index"() {"dim" = 2 : index, "offset" = #stencil.index<0, 4, 0>} : () -> index
...
// CHECK-NEXT:        %155 = "stencil.index"() {"dim" = 0 : index, "offset" = #stencil.index<0, 5, 0>} : () -> index
// CHECK-NEXT:        %156 = "stencil.index"() {"dim" = 1 : index, "offset" = #stencil.index<0, 5, 0>} : () -> index
// CHECK-NEXT:        %157 = "stencil.index"() {"dim" = 2 : index, "offset" = #stencil.index<0, 5, 0>} : () -> index
...
// CHECK-NEXT:        %160 = "stencil.index"() {"dim" = 0 : index, "offset" = #stencil.index<0, 6, 0>} : () -> index
// CHECK-NEXT:        %161 = "stencil.index"() {"dim" = 1 : index, "offset" = #stencil.index<0, 6, 0>} : () -> index
// CHECK-NEXT:        %162 = "stencil.index"() {"dim" = 2 : index, "offset" = #stencil.index<0, 6, 0>} : () -> index
...
// CHECK-NEXT:        %165 = "stencil.index"() {"dim" = 0 : index, "offset" = #stencil.index<0, 7, 0>} : () -> index
// CHECK-NEXT:        %166 = "stencil.index"() {"dim" = 1 : index, "offset" = #stencil.index<0, 7, 0>} : () -> index
// CHECK-NEXT:        %167 = "stencil.index"() {"dim" = 2 : index, "offset" = #stencil.index<0, 7, 0>} : () -> index
