...
module {
  func.func public @main(%arg0: memref<1x1x10x10xf32, strided<[?, ?, ?, ?], offset: ?>> {mhlo.layout_mode = "default"}, %arg1: memref<1x1x3x3xf32, strided<[?, ?, ?, ?], offset: ?>> {mhlo.layout_mode = "default"}, %arg2: memref<1x1x8x8xf32, strided<[?, ?, ?, ?], offset: ?>> {mhlo.layout_mode = "default", tf.aliasing_output = 0 : i32}) -> memref<1x1x8x8xf32, strided<[?, ?, ?, ?], offset: ?>> {
    ...
    memref.copy %collapse_shape, %arg2 : memref<1x1x8x8xf32> to memref<1x1x8x8xf32, strided<[?, ?, ?, ?], offset: ?>>
    return %arg2 : memref<1x1x8x8xf32, strided<[?, ?, ?, ?], offset: ?>>
  }
