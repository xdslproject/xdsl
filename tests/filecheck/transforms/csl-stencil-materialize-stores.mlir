...
builtin.module {
  ...
  ^bb1(%arg0_1: i16, %arg1_1: i16, %arg2_1: i16, %arg3_1: i16, %arg4_1: i16, %arg5_1: i16, %arg6_1: i16, %arg7_1: !csl.comptime_struct, %arg8_1: !csl.comptime_struct, %arg9: i1):
    ...
    csl.func @gauss_seidel() {
      ...
      ^bb2(%arg10: memref<4x510xf32>, %arg11: index, %arg12: memref<510xf32>):
      ...
      ^bb3(%arg10_1: memref<512xf32>, %arg11_1: memref<510xf32>):
...
// CHECK-NEXT:       ^bb2(%arg10: memref<4x510xf32>, %arg11: index, %arg12: memref<510xf32>):
...
// CHECK-NEXT:       }, {
// CHECK-NEXT:       ^bb3(%arg10_1: memref<512xf32>, %arg11_1: memref<510xf32>, %30: memref<512xf32>, %31: i1):
