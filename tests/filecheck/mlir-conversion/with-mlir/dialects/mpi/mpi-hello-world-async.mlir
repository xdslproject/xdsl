// RUN: xdsl-opt %s -p lower-mpi | $XDSL_MLIR_OPT --convert-func-to-llvm --expand-strided-metadata --normalize-memrefs --memref-expand --fold-memref-alias-ops --finalize-memref-to-llvm --reconcile-unrealized-casts | filecheck %s
