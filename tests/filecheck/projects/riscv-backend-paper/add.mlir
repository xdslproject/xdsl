...
// RUN: xdsl-opt %s -p convert-linalg-to-memref-stream,memref-streamify,convert-memref-stream-to-loops,convert-memref-stream-to-snitch-stream,convert-arith-to-riscv,convert-func-to-riscv-func,convert-memref-to-ptr,convert-ptr-to-riscv,convert-ptr-type-offsets,convert-arith-to-riscv,convert-memref-to-riscv,convert-scf-to-riscv-scf,convert-print-format-to-riscv-debug,reconcile-unrealized-casts,snitch-allocate-registers | xdsl-run | filecheck %s
