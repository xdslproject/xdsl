...
//  CHECK-NEXT:      x86.ss.cmp %zero_1, %forty : (!x86.reg<r9>, !x86.reg<r8>) -> ()
//  CHECK-NEXT:      x86.c.jl ^bb0(%zero_1 : !x86.reg<r9>), ^bb1(%zero_1 : !x86.reg<r9>)
...
//  CHECK-NEXT:      x86.ss.cmp %offset_2, %forty : (!x86.reg<r9>, !x86.reg<r8>) -> ()
//  CHECK-NEXT:      x86.c.jl ^bb1(%offset_2 : !x86.reg<r9>), ^bb0(%offset_2 : !x86.reg<r9>)
...
//  CHECK-NEXT:      x86.ss.cmp %zero_outer_1, %forty_outer : (!x86.reg<r9>, !x86.reg<r8>) -> ()
//  CHECK-NEXT:      x86.c.jl ^bb0(%zero_outer_1 : !x86.reg<r9>), ^bb1(%zero_outer_1 : !x86.reg<r9>)
...
//  CHECK-NEXT:      x86.ss.cmp %zero_inner_1, %forty_inner : (!x86.reg<r13>, !x86.reg<r12>) -> ()
//  CHECK-NEXT:      x86.c.jl ^bb2(%zero_inner_1 : !x86.reg<r13>), ^bb3(%zero_inner_1 : !x86.reg<r13>)
...
//  CHECK-NEXT:      x86.ss.cmp %offset_inner_2, %forty_inner : (!x86.reg<r13>, !x86.reg<r12>) -> ()
//  CHECK-NEXT:      x86.c.jl ^bb3(%offset_inner_2 : !x86.reg<r13>), ^bb2(%offset_inner_2 : !x86.reg<r13>)
...
//  CHECK-NEXT:      x86.ss.cmp %offset_outer_2, %forty_outer : (!x86.reg<r9>, !x86.reg<r8>) -> ()
//  CHECK-NEXT:      x86.c.jl ^bb1(%offset_outer_2 : !x86.reg<r9>), ^bb0(%offset_outer_2 : !x86.reg<r9>)
