...
// CHECK-NEXT:   %[[FRAC1:.*]] = arith.divf %[[X]], %[[I1]] : f64
// CHECK-NEXT:   %[[TERM1:.*]] = arith.mulf %[[FRAC1]], %[[TERM0]] : f64
// CHECK-NEXT:   %[[RES1:.*]] = arith.addf %[[RES0]], %[[TERM1]] : f64
// CHECK-NEXT:   %[[I2:.*]] = arith.constant 2.000000e+00 : f64
// CHECK-NEXT:   %[[FRAC2:.*]] = arith.divf %[[X]], %[[I2]] : f64
// CHECK-NEXT:   %[[TERM2:.*]] = arith.mulf %[[FRAC2]], %[[TERM1]] : f64
// CHECK-NEXT:   %[[RES2:.*]] = arith.addf %[[RES1]], %[[TERM2]] : f64
// CHECK-NEXT:   %[[I3:.*]] = arith.constant 3.000000e+00 : f64
// CHECK-NEXT:   %[[FRAC3:.*]] = arith.divf %[[X]], %[[I3]] : f64
...
// CHECK-NEXT:   %[[FRAC1_32:.*]] = arith.divf %[[X32]], %[[I1_32]] : f32
// CHECK-NEXT:   %[[TERM1_32:.*]] = arith.mulf %[[FRAC1_32]], %[[TERM0_32]] : f32
// CHECK-NEXT:   %[[RES1_32:.*]] = arith.addf %[[RES0_32]], %[[TERM1_32]] : f32
// CHECK-NEXT:   %[[I2_32:.*]] = arith.constant 2.000000e+00 : f32
// CHECK-NEXT:   %[[FRAC2_32:.*]] = arith.divf %[[X32]], %[[I2_32]] : f32
// CHECK-NEXT:   %[[TERM2_32:.*]] = arith.mulf %[[FRAC2_32]], %[[TERM1_32]] : f32
// CHECK-NEXT:   %[[RES2_32:.*]] = arith.addf %[[RES1_32]], %[[TERM2_32]] : f32
// CHECK-NEXT:   %[[I3_32:.*]] = arith.constant 3.000000e+00 : f32
// CHECK-NEXT:   %[[FRAC3_32:.*]] = arith.divf %[[X32]], %[[I3_32]] : f32
...
// CHECK-NEXT:   %[[FRAC1_V:.*]] = arith.divf %[[XV]], %[[I1_V]] : vector<2xf32>
// CHECK-NEXT:   %[[TERM1_V:.*]] = arith.mulf %[[FRAC1_V]], %[[TERM0_V]] : vector<2xf32>
// CHECK-NEXT:   %[[RES1_V:.*]] = arith.addf %[[RES0_V]], %[[TERM1_V]] : vector<2xf32>
// CHECK-NEXT:   %[[I2_V:.*]] = arith.constant dense<2.000000e+00> : vector<2xf32>
// CHECK-NEXT:   %[[FRAC2_V:.*]] = arith.divf %[[XV]], %[[I2_V]] : vector<2xf32>
// CHECK-NEXT:   %[[TERM2_V:.*]] = arith.mulf %[[FRAC2_V]], %[[TERM1_V]] : vector<2xf32>
// CHECK-NEXT:   %[[RES2_V:.*]] = arith.addf %[[RES1_V]], %[[TERM2_V]] : vector<2xf32>
// CHECK-NEXT:   %[[I3_V:.*]] = arith.constant dense<3.000000e+00> : vector<2xf32>
// CHECK-NEXT:   %[[FRAC3_V:.*]] = arith.divf %[[XV]], %[[I3_V]] : vector<2xf32>
...
// CHECK-FIVE-NEXT:   %[[FRAC1:.*]] = arith.divf %[[X]], %[[I1]] : f64
// CHECK-FIVE-NEXT:   %[[TERM1:.*]] = arith.mulf %[[FRAC1]], %[[TERM0]] : f64
// CHECK-FIVE-NEXT:   %[[RES1:.*]] = arith.addf %[[RES0]], %[[TERM1]] : f64
// CHECK-FIVE-NEXT:   %[[I2:.*]] = arith.constant 2.000000e+00 : f64
// CHECK-FIVE-NEXT:   %[[FRAC2:.*]] = arith.divf %[[X]], %[[I2]] : f64
// CHECK-FIVE-NEXT:   %[[TERM2:.*]] = arith.mulf %[[FRAC2]], %[[TERM1]] : f64
// CHECK-FIVE-NEXT:   %[[RES2:.*]] = arith.addf %[[RES1]], %[[TERM2]] : f64
// CHECK-FIVE-NEXT:   %[[I3:.*]] = arith.constant 3.000000e+00 : f64
// CHECK-FIVE-NEXT:   %[[FRAC3:.*]] = arith.divf %[[X]], %[[I3]] : f64
// CHECK-FIVE-NEXT:   %[[TERM3:.*]] = arith.mulf %[[FRAC3]], %[[TERM2]] : f64
// CHECK-FIVE-NEXT:   %[[RES3:.*]] = arith.addf %[[RES2]], %[[TERM3]] : f64
// CHECK-FIVE-NEXT:   %[[I4:.*]] = arith.constant 4.000000e+00 : f64
// CHECK-FIVE-NEXT:   %[[FRAC4:.*]] = arith.divf %[[X]], %[[I4]] : f64
...
// CHECK-FIVE-NEXT:   %[[FRAC1_32:.*]] = arith.divf %[[X32]], %[[I1_32]] : f32
// CHECK-FIVE-NEXT:   %[[TERM1_32:.*]] = arith.mulf %[[FRAC1_32]], %[[TERM0_32]] : f32
// CHECK-FIVE-NEXT:   %[[RES1_32:.*]] = arith.addf %[[RES0_32]], %[[TERM1_32]] : f32
// CHECK-FIVE-NEXT:   %[[I2_32:.*]] = arith.constant 2.000000e+00 : f32
// CHECK-FIVE-NEXT:   %[[FRAC2_32:.*]] = arith.divf %[[X32]], %[[I2_32]] : f32
// CHECK-FIVE-NEXT:   %[[TERM2_32:.*]] = arith.mulf %[[FRAC2_32]], %[[TERM1_32]] : f32
// CHECK-FIVE-NEXT:   %[[RES2_32:.*]] = arith.addf %[[RES1_32]], %[[TERM2_32]] : f32
// CHECK-FIVE-NEXT:   %[[I3_32:.*]] = arith.constant 3.000000e+00 : f32
// CHECK-FIVE-NEXT:   %[[FRAC3_32:.*]] = arith.divf %[[X32]], %[[I3_32]] : f32
// CHECK-FIVE-NEXT:   %[[TERM3_32:.*]] = arith.mulf %[[FRAC3_32]], %[[TERM2_32]] : f32
// CHECK-FIVE-NEXT:   %[[RES3_32:.*]] = arith.addf %[[RES2_32]], %[[TERM3_32]] : f32
// CHECK-FIVE-NEXT:   %[[I4_32:.*]] = arith.constant 4.000000e+00 : f32
// CHECK-FIVE-NEXT:   %[[FRAC4_32:.*]] = arith.divf %[[X32]], %[[I4_32]] : f32
...
// CHECK-FIVE-NEXT:   %[[FRAC1_V:.*]] = arith.divf %[[XV]], %[[I1_V]] : vector<2xf32>
...
// CHECK-FIVE-NEXT:   %[[I2_V:.*]] = arith.constant dense<2.000000e+00> : vector<2xf32>
// CHECK-FIVE-NEXT:   %[[FRAC2_V:.*]] = arith.divf %[[XV]], %[[I2_V]] : vector<2xf32>
...
// CHECK-FIVE-NEXT:   %[[I3_V:.*]] = arith.constant dense<3.000000e+00> : vector<2xf32>
// CHECK-FIVE-NEXT:   %[[FRAC3_V:.*]] = arith.divf %[[XV]], %[[I3_V]] : vector<2xf32>
...
// CHECK-FIVE-NEXT:   %[[I4_V:.*]] = arith.constant dense<4.000000e+00> : vector<2xf32>
// CHECK-FIVE-NEXT:   %[[FRAC4_V:.*]] = arith.divf %[[XV]], %[[I4_V]] : vector<2xf32>
