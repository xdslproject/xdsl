...
builtin.module {
  func.func private @stencil_buffer(%0 : !stencil.field<[-4,68]xf64>, %1 : !stencil.field<[-4,68]xf64>) {
    ...
    %2 = "stencil.combine"(%15, %12) {dim=#builtin.int<0>, index=#builtin.int<11>, operandSegmentSizes = array<i32:1,1,0,0>} : (!stencil.temp<?xf64>, !stencil.temp<?xf64>) -> !stencil.temp<?xf64>
...
// CHECK-NEXT:     }) : (!stencil.temp<?xf64>) -> !stencil.temp<?xf64>
// CHECK-NEXT:      %10 = "stencil.combine"(%6, %7) {"dim" = #builtin.int<0>, "index" = #builtin.int<11>, "operandSegmentSizes" = array<i32: 1, 1, 0, 0>} : (!stencil.temp<?xf64>, !stencil.temp<?xf64>) -> !stencil.temp<?xf64>
...
builtin.module {
  func.func private @stencil_dyn_access(%0 : !stencil.field<?x?xf64>, %1 : !stencil.field<?x?xf64>) {
    ...
    %5 = "stencil.apply"(%4) ({
    ^0(%6 : !stencil.temp<[-1,65]x[-1,65]xf64>):
      %i = "stencil.index"() {"dim" = #builtin.int<0>, "offset" = #stencil.index<-1, -1>} : () -> index
      %j = "stencil.index"() {"dim" = #builtin.int<1>, "offset" = #stencil.index<1, 1>} : () -> index
...
// CHECK-NEXT:     %5 = "stencil.apply"(%4) ({
// CHECK-NEXT:     ^0(%6 : !stencil.temp<[-1,65]x[-1,65]xf64>):
// CHECK-NEXT:       %i = "stencil.index"() {"dim" = #builtin.int<0>, "offset" = #stencil.index<-1, -1>} : () -> index
// CHECK-NEXT:       %j = "stencil.index"() {"dim" = #builtin.int<1>, "offset" = #stencil.index<1, 1>} : () -> index
