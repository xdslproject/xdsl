...
Onnx = Dialect(
    [
        ...
        ONNXGatherNDOp,
        ONNXGemmOp,
        ONNXGlobalAveragePoolOp,
        ONNXGlobalLpPoolOp,
        ONNXGlobalMaxPoolOp,
        ONNXGreaterOp,
        ONNXGreaterOrEqualOp,
        ONNXGridSampleOp,
        ONNXHardSigmoidOp,
        ONNXHardSwishOp,
        ONNXHardmaxOp,
        ...
        ONNXMaxUnpoolOp,
        ONNXMeanOp,
        ONNXMeanVarianceNormalizationOp,
        ONNXMinOp,
        ONNXModOp,
        ONNXMulOp,
        ONNXMultinomialOp,
        ONNXNegOp,
        ONNXNegativeLogLikelihoodLossOp,
        ONNXNonMaxSuppressionOp,
        ONNXNonZeroOp,
        ONNXNotOp,
        ONNXOneHotOp,
        ONNXOptionalOp,
        ONNXOptionalGetElementOp,
        ONNXOptionalHasElementOp,
        ONNXOrOp,
        ONNXPReluOp,
        ONNXPadOp,
        ONNXPadV11Op,
        ...
        ONNXRNNOp,
        ONNXRandomNormalOp,
        ONNXRandomNormalLikeOp,
        ONNXRandomUniformOp,
        ONNXRandomUniformLikeOp,
        ONNXRangeOp,
        ONNXReciprocalOp,
        ONNXReduceL1Op,
        ONNXReduceL2Op,
        ONNXReduceLogSumOp,
        ONNXReduceLogSumExpOp,
        ONNXReduceMaxOp,
        ONNXReduceMeanOp,
        ONNXReduceMinOp,
        ONNXReduceProdOp,
        ...
        ONNXScanOp,
        ONNXScatterOp,
        ONNXScatterElementsOp,
        ONNXScatterNDOp,
        ONNXSeluOp,
        ONNXSequenceAtOp,
        ONNXSequenceConstructOp,
        ONNXSequenceEmptyOp,
        ONNXSequenceEraseOp,
        ONNXSequenceInsertOp,
        ONNXSequenceLengthOp,
        ONNXShapeOp,
        ONNXShrinkOp,
        ONNXSigmoidOp,
        ONNXSignOp,
        ...
        ONNXSqueezeOp,
        ONNXSqueezeV11Op,
        ONNXStringNormalizerOp,
        ONNXSubOp,
        ONNXSumOp,
        ONNXTanOp,
        ONNXTanhOp,
        ONNXTfIdfVectorizerOp,
        ONNXThresholdedReluOp,
        ONNXTileOp,
        ONNXTopKOp,
        ONNXTransposeOp,
        ONNXTriluOp,
        ...
        ONNXWhereOp,
        ONNXXorOp,
        ONNXArrayFeatureExtractorOp,
        ONNXBinarizerOp,
        ONNXCastMapOp,
        ONNXCategoryMapperOp,
        ONNXDictVectorizerOp,
        ONNXFeatureVectorizerOp,
        ONNXImputerOp,
        ONNXLabelEncoderOp,
        ONNXLinearClassifierOp,
        ONNXLinearRegressorOp,
        ONNXNormalizerOp,
        ONNXOneHotEncoderOp,
        ONNXSVMClassifierOp,
        ONNXSVMRegressorOp,
        ONNXScalerOp,
        ONNXTreeEnsembleClassifierOp,
        ONNXTreeEnsembleRegressorOp,
        ONNXZipMapOp,
        ONNXAdagradOp,
        ONNXAdamOp,
        ONNXGradientOp,
