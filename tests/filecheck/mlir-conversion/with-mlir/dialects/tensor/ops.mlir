...
%src = "arith.constant"() {"value" = dense<1.000000e-01> : tensor<4x1xf32>} : () -> tensor<4x1xf32>
%shape = tensor.empty() : tensor<1xi32>
...
// CHECK-NEXT:  %4 = arith.constant dense<1.000000e-01> : tensor<4x1xf32>
// CHECK-NEXT:  %5 =  tensor.empty() : tensor<1xi32>
// CHECK-NEXT:  %6 =  tensor.reshape %src(%shape) : (tensor<4x1xf32>, tensor<1xi32>) -> tensor<4xf32>
// CHECK-NEXT: }
