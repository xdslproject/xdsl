...
builtin.module {
  ...
  ^bb0(%arg35 : i16, %arg36 : i16, %arg37 : i16, %arg38 : i16, %arg39 : i16, %arg40 : i16, %arg41 : i16, %arg42 : i16, %arg43 : i16):
  ...
  ^bb1(%arg0 : i16, %arg1 : i16, %arg2 : i16, %arg3 : i16, %arg4 : i16, %arg5 : i16, %arg6 : i16, %arg7 : !csl.comptime_struct, %arg8 : !csl.comptime_struct, %arg9 : i1):
    ...
    csl.func @loop_kernel() {
      ...
      scf.for %arg10 = %21 to %20 step %19 {
        ...
        ^bb1(%arg23 : memref<4x2xf32>, %arg24 : index, %arg25 : memref<2xf32>):
          csl_stencil.yield %arg25 : memref<2xf32>
        }, {
        ^bb2(%arg11 : memref<4xf32>, %arg12 : memref<2xf32>):
          csl_stencil.yield
        }) to <[0, 0], [1, 1]>
      }
      csl.return
...
// CHECK-NEXT:   ^bb0(%arg35 : i16, %arg36 : i16, %arg37 : i16, %arg38 : i16, %arg39 : i16, %arg40 : i16, %arg41 : i16, %arg42 : i16, %arg43 : i16):
  ...
  ^bb1(%arg0 : i16, %arg1 : i16, %arg2 : i16, %arg3 : i16, %arg4 : i16, %arg5 : i16, %arg6 : i16, %arg7 : !csl.comptime_struct, %arg8 : !csl.comptime_struct, %arg9 : i1):
    ...
    csl.func @loop_kernel() {
      ...
      scf.for %arg10 = %6 to %5 step %4 {
        ...
        ^bb2(%arg23 : memref<4x2xf32>, %arg24 : index, %arg25 : memref<2xf32>):
          csl_stencil.yield %arg25 : memref<2xf32>
        }, {
        ^bb3(%arg11 : memref<4xf32>, %arg12 : memref<2xf32>):
          csl_stencil.yield
        }) to <[0, 0], [1, 1]>
      }
      scf.for %arg10 = %6 to %5 step %4 {
