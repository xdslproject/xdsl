...
// CHECK-NEXT:    %2 = "llvm.ptrtoint"(%1) : (!llvm.ptr) -> i64
// CHECK-NEXT:    %3 = "llvm.mlir.null"() : () -> !llvm.ptr
// CHECK-NEXT:    %4 = "llvm.alloca"(%0) <{alignment = 32 : i64, elem_type = i64}> : (i64) -> !llvm.ptr
// CHECK-NEXT:    %5 = "llvm.alloca"(%0) <{alignment = 32 : i64, elem_type = i32}> : (i64) -> !llvm.ptr
// CHECK-NEXT:    %6 = "llvm.getelementptr"(%5, %0) <{elem_type = i64, noWrapFlags = 0 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
// CHECK-NEXT:    "llvm.store"(%7, %5) <{alignment = 32 : i64, nontemporal, ordering = 0 : i64, volatile_}> : (i64, !llvm.ptr) -> ()
// CHECK-NEXT:    %8 = "llvm.load"(%1) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
// CHECK-NEXT:    %7 = "llvm.load"(%4) <{ordering = 0 : i64}> : (!llvm.ptr) -> i64
// CHECK-NEXT:    %9 = "llvm.load"(%4) <{alignment = 16 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
// CHECK-NEXT:    %10 = "llvm.load"(%4) <{alignment = 32 : i64, ordering = 1 : i64}> : (!llvm.ptr) -> i32
// CHECK-NEXT:  }) : () -> ()
