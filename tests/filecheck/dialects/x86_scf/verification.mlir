...
"x86_scf.for"(%lb, %ub, %step) <{ub_attr = 10 : i64, operandSegmentSizes = array<i32: 1, 1, 1, 0>}> ({
^bb0(%i: !x86.reg64):
    x86_scf.yield
...
"x86_scf.for"(%lb, %ub, %step) <{step_attr = 1 : i64, operandSegmentSizes = array<i32: 1, 1, 1, 0>}> ({
^bb0(%i: !x86.reg64):
    x86_scf.yield
}) : (!x86.reg64, !x86.reg64, !x86.reg64) -> ()
...
x86_scf.for %i : !x86.reg64 = %lb to 1 : f32 step 1 : i64 {
    x86_scf.yield
}
...
x86_scf.for %i : !x86.reg64 = %lb to 1 : i64 step 1 : f32 {
    x86_scf.yield
}
