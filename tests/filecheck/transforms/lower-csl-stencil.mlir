...
// CHECK-NEXT:       "csl.member_call"(%34, %arg0, %37) <{"field" = "communicate"}> : (!csl.imported_module, memref<512xf32>, i16) -> ()
// CHECK-NEXT:       csl.return
// CHECK-NEXT:     }
// CHECK-NEXT:     csl.func @chunk_reduce_cb(%38 : i16) {
// CHECK-NEXT:       %arg3 = arith.index_cast %38 : i16 to index
// CHECK-NEXT:       %39 = arith.constant 1 : i16
// CHECK-NEXT:       %40 = "csl.member_call"(%34, %39) <{"field" = "getRecvBufDsdByNeighbor"}> : (!csl.imported_module, i16) -> !csl<dsd mem1d_dsd>
// CHECK-NEXT:       %41 = builtin.unrealized_conversion_cast %40 : !csl<dsd mem1d_dsd> to memref<255xf32>
// CHECK-NEXT:       %42 = arith.constant 1 : i16
// CHECK-NEXT:       %43 = "csl.member_call"(%34, %42) <{"field" = "getRecvBufDsdByNeighbor"}> : (!csl.imported_module, i16) -> !csl<dsd mem1d_dsd>
...
// CHECK-NEXT:       %46 = "csl.member_call"(%34, %45) <{"field" = "getRecvBufDsdByNeighbor"}> : (!csl.imported_module, i16) -> !csl<dsd mem1d_dsd>
...
// CHECK-NEXT:       %49 = "csl.member_call"(%34, %48) <{"field" = "getRecvBufDsdByNeighbor"}> : (!csl.imported_module, i16) -> !csl<dsd mem1d_dsd>
// CHECK-NEXT:       %50 = builtin.unrealized_conversion_cast %49 : !csl<dsd mem1d_dsd> to memref<255xf32>
// CHECK-NEXT:       %51 = memref.subview %arg4[%arg3] [255] [1] : memref<510xf32> to memref<255xf32, strided<[1], offset: ?>>
// CHECK-NEXT:       "csl.fadds"(%51, %50, %47) : (memref<255xf32, strided<[1], offset: ?>>, memref<255xf32>, memref<255xf32>) -> ()
// CHECK-NEXT:       "csl.fadds"(%51, %51, %44) : (memref<255xf32, strided<[1], offset: ?>>, memref<255xf32, strided<[1], offset: ?>>, memref<255xf32>) -> ()
// CHECK-NEXT:       "csl.fadds"(%51, %51, %41) : (memref<255xf32, strided<[1], offset: ?>>, memref<255xf32, strided<[1], offset: ?>>, memref<255xf32>) -> ()
// CHECK-NEXT:       csl.return
// CHECK-NEXT:     }
// CHECK-NEXT:     csl.func @post_process_cb() {
// CHECK-NEXT:       %52 = memref.subview %arg0[2] [510] [1] : memref<512xf32> to memref<510xf32, strided<[1], offset: 2>>
// CHECK-NEXT:       %53 = memref.subview %arg0[0] [510] [1] : memref<512xf32> to memref<510xf32, strided<[1]>>
// CHECK-NEXT:       "csl.fadds"(%arg4, %arg4, %53) : (memref<510xf32>, memref<510xf32>, memref<510xf32, strided<[1]>>) -> ()
// CHECK-NEXT:       "csl.fadds"(%arg4, %arg4, %52) : (memref<510xf32>, memref<510xf32>, memref<510xf32, strided<[1], offset: 2>>) -> ()
// CHECK-NEXT:       %54 = arith.constant 1.666600e-01 : f32
// CHECK-NEXT:       "csl.fmuls"(%arg4, %arg4, %54) : (memref<510xf32>, memref<510xf32>, f32) -> ()
// CHECK-NEXT:       csl.return
// CHECK-NEXT:     }
