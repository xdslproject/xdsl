...
def simple_linear_riscv():
    ...
    def text_region():
        ...
        def main_region() -> None:
            zero = riscv.GetRegisterOp(riscv.IntegerRegisters.ZERO).res
            ...
            riscv.MVOp(v16, rd=riscv.IntegerRegisters.A0)
            riscv.AddiOp(zero, 93, rd=riscv.IntegerRegisters.A7).rd
            riscv.EcallOp()
...
def simple_linear_riscv_allocated():
    ...
    def text_region():
        ...
        def main_region() -> None:
            zero = riscv.GetRegisterOp(riscv.IntegerRegisters.ZERO).res
            v0 = riscv.AddiOp(zero, 1, rd=riscv.IntegerRegisters.T6).rd
            v1 = riscv.AddiOp(zero, 2, rd=riscv.IntegerRegisters.T5).rd

            v3 = riscv.AddOp(v1, v0, rd=riscv.IntegerRegisters.T4).rd
            v4 = riscv.MulOp(v3, v1, rd=riscv.IntegerRegisters.T3).rd
            v5 = riscv.SubOp(v0, v4, rd=riscv.IntegerRegisters.S11).rd
            v6 = riscv.MulOp(v1, v0, rd=riscv.IntegerRegisters.S10).rd
            v7 = riscv.AddOp(v6, v3, rd=riscv.IntegerRegisters.S9).rd
            v8 = riscv.AddOp(v7, v5, rd=riscv.IntegerRegisters.S8).rd
            v9 = riscv.SubOp(v0, v1, rd=riscv.IntegerRegisters.S7).rd
            v10 = riscv.MulOp(v5, v3, rd=riscv.IntegerRegisters.S6).rd
            v11 = riscv.AddOp(v9, v10, rd=riscv.IntegerRegisters.S5).rd
            v12 = riscv.AddOp(v11, v8, rd=riscv.IntegerRegisters.S4).rd
            v13 = riscv.AddOp(v4, v0, rd=riscv.IntegerRegisters.S3).rd
            v14 = riscv.SubOp(v13, v5, rd=riscv.IntegerRegisters.S2).rd
            v15 = riscv.MulOp(v12, v8, rd=riscv.IntegerRegisters.A7).rd
            v16 = riscv.AddOp(v14, v15, rd=riscv.IntegerRegisters.A6).rd
