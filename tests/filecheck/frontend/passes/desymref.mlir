...
// CHECK: "builtin.module"() ({
  ...
  "builtin.module"() ({
    ...
    "symref.update"(%1) {"symbol" = @a} : (i32) -> ()
    %3 = "arith.constant"() {"value" = 23 : i32} : () -> i32
    "symref.update"(%1) {"symbol" = @a} : (i32) -> ()
  }) : () -> ()
  ...
  "builtin.module"() ({
    "symref.declare"() {"sym_name" = "a"} : () -> ()
    %9 = "arith.constant"() {"value" = 11 : i32} : () -> i32
    "symref.update"(%9) {"symbol" = @a} : (i32) -> ()
    "symref.declare"() {"sym_name" = "b"} : () -> ()
    %10 = "arith.constant"() {"value" = 22 : i32} : () -> i32
  ...
  "builtin.module"() ({
    ...
    %32 = "arith.muli"(%31, %31) : (i32, i32) -> i32
    %33 = "symref.fetch"() {"symbol" = @b} : () -> i32
    %34 = "arith.constant"() {"value" = 5 : i32} : () -> i32
