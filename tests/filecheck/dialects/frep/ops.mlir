...
// CHECK-NEXT:      %{{.*}} = riscv.fadd.s %ft0, %ft1 : (!riscv.freg<ft0>, !riscv.freg<ft1>) -> !riscv.freg<ft2>
...
// CHECK-GENERIC-NEXT:      %{{.*}} = "riscv.fadd.s"(%{{.*}}, %{{.*}}) : (!riscv.freg<ft0>, !riscv.freg<ft1>) -> !riscv.freg<ft2>
