...
x86.ms.add [%1 + 8], %1 : (!x86.reg64, !x86.reg64) -> ()
// CHECK-NEXT: x86.ms.add [%{{.*}} + 8], %{{.*}} : (!x86.reg64, !x86.reg64) -> ()
x86.ms.sub [%1 + -8], %1 : (!x86.reg64, !x86.reg64) -> ()
// CHECK-NEXT: x86.ms.sub [%{{.*}} + -8], %{{.*}} : (!x86.reg64, !x86.reg64) -> ()
x86.ms.and [%1 + 8], %1 : (!x86.reg64, !x86.reg64) -> ()
// CHECK-NEXT: x86.ms.and [%{{.*}} + 8], %{{.*}} : (!x86.reg64, !x86.reg64) -> ()
x86.ms.or [%1 + 8], %1 : (!x86.reg64, !x86.reg64) -> ()
// CHECK-NEXT: x86.ms.or [%{{.*}} + 8], %{{.*}} : (!x86.reg64, !x86.reg64) -> ()
x86.ms.xor [%1 + 8], %1 : (!x86.reg64, !x86.reg64) -> ()
// CHECK-NEXT: x86.ms.xor [%{{.*}} + 8], %{{.*}} : (!x86.reg64, !x86.reg64) -> ()
x86.ms.mov [%1 + 8], %1 : (!x86.reg64, !x86.reg64) -> ()
// CHECK-NEXT: x86.ms.mov [%{{.*}} + 8], %{{.*}} : (!x86.reg64, !x86.reg64) -> ()
%mr.cmp = x86.ms.cmp [%1 + 8], %1 : (!x86.reg64, !x86.reg64) -> !x86.rflags<rflags>
// CHECK-NEXT: %{{.*}} = x86.ms.cmp [%{{.*}} + 8], %{{.*}} : (!x86.reg64, !x86.reg64) -> !x86.rflags

x86.mi.add [%1], 2 : (!x86.reg64) -> ()
// CHECK-NEXT: x86.mi.add [%{{.*}}], 2 : (!x86.reg64) -> ()
x86.mi.add [%1 + 8], 2 : (!x86.reg64) -> ()
// CHECK-NEXT: x86.mi.add [%{{.*}} + 8], 2 : (!x86.reg64) -> ()
x86.mi.sub [%1 + -8], 2 : (!x86.reg64) -> ()
// CHECK-NEXT: x86.mi.sub [%{{.*}} + -8], 2 : (!x86.reg64) -> ()
x86.mi.and [%1 + 8], 2 : (!x86.reg64) -> ()
// CHECK-NEXT: x86.mi.and [%{{.*}} + 8], 2 : (!x86.reg64) -> ()
x86.mi.or [%1 + 8], 2 : (!x86.reg64) -> ()
// CHECK-NEXT: x86.mi.or [%{{.*}} + 8], 2 : (!x86.reg64) -> ()
x86.mi.xor [%1 + 8], 2 : (!x86.reg64) -> ()
// CHECK-NEXT: x86.mi.xor [%{{.*}} + 8], 2 : (!x86.reg64) -> ()
x86.mi.mov [%1 + 8], 2 : (!x86.reg64) -> ()
// CHECK-NEXT: x86.mi.mov [%{{.*}} + 8], 2 : (!x86.reg64) -> ()
%mi_cmp = x86.mi.cmp [%1 + 8], 2 : !x86.reg64 -> !x86.rflags<rflags>
// CHECK-NEXT: %{{.*}} = x86.mi.cmp [%{{.*}} + 8], 2 : !x86.reg64 -> !x86.rflags
...
%rmi_imul = x86.dmi.imul [%1 + 8], 2 : (!x86.reg64) ->  !x86.reg64
// CHECK-NEXT: %{{.*}} = x86.dmi.imul [%{{.*}} + 8], 2 : (!x86.reg64) -> !x86.reg64
...
%m_idiv_rdx2, %m_idiv_rax2 = x86.m.idiv [%1 + 8], %rdx, %rax : (!x86.reg64, !x86.reg64<rdx>, !x86.reg64<rax>) -> (!x86.reg64<rdx>, !x86.reg64<rax>)
// CHECK-NEXT: %{{.*}}, %{{.*}} = x86.m.idiv [%{{.*}} + 8], %{{.*}}, %{{.*}} : (!x86.reg64, !x86.reg64<rdx>, !x86.reg64<rax>) -> (!x86.reg64<rdx>, !x86.reg64<rax>)
%m_imul_rdx, %m_imul_rax = x86.m.imul [%1 + 8], %rax : (!x86.reg64, !x86.reg64<rax>) -> (!x86.reg64<rdx>, !x86.reg64<rax>)
...
// ---- vmulpd ----
%vmulpd_sse = x86.dss.vmulpd %xmm1, %xmm2 : (!x86.ssereg, !x86.ssereg) -> !x86.ssereg
// CHECK: %vmulpd_sse = x86.dss.vmulpd %xmm1, %xmm2 : (!x86.ssereg, !x86.ssereg) -> !x86.ssereg
%vmulpd_avx2 = x86.dss.vmulpd %ymm1, %ymm2 : (!x86.avx2reg, !x86.avx2reg) -> !x86.avx2reg
// CHECK-NEXT: %vmulpd_avx2 = x86.dss.vmulpd %ymm1, %ymm2 : (!x86.avx2reg, !x86.avx2reg) -> !x86.avx2reg
%vmulpd_avx512 = x86.dss.vmulpd %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
// CHECK-NEXT: %vmulpd_avx512 = x86.dss.vmulpd %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
...
%vaddsd = x86.dss.vaddsd %xmm0, %xmm1 : (!x86.ssereg, !x86.ssereg) -> !x86.ssereg
// CHECK-NEXT: %vaddsd = x86.dss.vaddsd %xmm0, %xmm1 : (!x86.ssereg, !x86.ssereg) -> !x86.ssereg
...
// CHECK-NEXT: %dss_vpxord_avx512 = x86.dss.vpxord %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
%dss_vpxord_zero_avx512 = x86.dss.vpxord %zmm1, %zmm1 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
// CHECK-NEXT: %dss_vpxord_zero_avx512 = x86.dss.vpxord %zmm1, %zmm1 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
%dss_vpxorq_avx512 = x86.dss.vpxorq %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
// CHECK-NEXT: %dss_vpxorq_avx512 = x86.dss.vpxorq %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
%dss_vxorpd_avx512 = x86.dss.vxorpd %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
// CHECK-NEXT: %dss_vxorpd_avx512 = x86.dss.vxorpd %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
%dss_vxorps_avx512 = x86.dss.vxorps %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
// CHECK-NEXT: %dss_vxorps_avx512 = x86.dss.vxorps %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
...
x86.ms.vmovapd [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
// CHECK-NEXT: x86.ms.vmovapd [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
x86.ms.vmovapd [%1 + 8], %zmm1 : (!x86.reg64, !x86.avx512reg) -> ()
// CHECK-NEXT: x86.ms.vmovapd [%1 + 8], %zmm1 : (!x86.reg64, !x86.avx512reg) -> ()
...
x86.ms.vmovaps [%1 + 8], %xmm1 : (!x86.reg64, !x86.ssereg) -> ()
// CHECK-NEXT: x86.ms.vmovaps [%1 + 8], %xmm1 : (!x86.reg64, !x86.ssereg) -> ()
x86.ms.vmovaps [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
// CHECK-NEXT: x86.ms.vmovaps [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
x86.ms.vmovaps [%1 + 8], %zmm1 : (!x86.reg64, !x86.avx512reg) -> ()
// CHECK-NEXT: x86.ms.vmovaps [%1 + 8], %zmm1 : (!x86.reg64, !x86.avx512reg) -> ()
...
x86.ms.vmovupd [%1 + 8], %xmm1 : (!x86.reg64, !x86.ssereg) -> ()
// CHECK-NEXT: x86.ms.vmovupd [%1 + 8], %xmm1 : (!x86.reg64, !x86.ssereg) -> ()
x86.ms.vmovupd [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
// CHECK-NEXT: x86.ms.vmovupd [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
x86.ms.vmovupd [%1 + 8], %zmm1 : (!x86.reg64, !x86.avx512reg) -> ()
// CHECK-NEXT: x86.ms.vmovupd [%1 + 8], %zmm1 : (!x86.reg64, !x86.avx512reg) -> ()
...
x86.ms.vmovups [%1 + 8], %xmm1 : (!x86.reg64, !x86.ssereg) -> ()
// CHECK-NEXT: x86.ms.vmovups [%1 + 8], %xmm1 : (!x86.reg64, !x86.ssereg) -> ()
x86.ms.vmovups [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
...
// CHECK-NEXT: %dmk_vmovapd = x86.dmk.vmovapd[%1], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
%dmk_vmovapd_offset = x86.dmk.vmovapd [%1 + 8], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovapd_offset = x86.dmk.vmovapd[%1 + 8], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
%dmk_vmovapd_z = x86.dmk.vmovapd [%1], %k1 {z} : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovapd_z = x86.dmk.vmovapd[%1], %k1 {z} : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg

// ---- dmk.vmovupd (masked load) ----
%dmk_vmovupd = x86.dmk.vmovupd [%1], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovupd = x86.dmk.vmovupd[%1], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
%dmk_vmovupd_offset = x86.dmk.vmovupd [%1 + 8], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovupd_offset = x86.dmk.vmovupd[%1 + 8], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
%dmk_vmovupd_z = x86.dmk.vmovupd [%1], %k1 {z} : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovupd_z = x86.dmk.vmovupd[%1], %k1 {z} : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg

// ---- dmk.vmovaps (masked load) ----
%dmk_vmovaps = x86.dmk.vmovaps [%1], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovaps = x86.dmk.vmovaps[%1], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
%dmk_vmovaps_offset = x86.dmk.vmovaps [%1 + 8], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovaps_offset = x86.dmk.vmovaps[%1 + 8], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
%dmk_vmovaps_z = x86.dmk.vmovaps [%1], %k1 {z} : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovaps_z = x86.dmk.vmovaps[%1], %k1 {z} : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg

// ---- dmk.vmovups (masked load) ----
%dmk_vmovups = x86.dmk.vmovups [%1], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovups = x86.dmk.vmovups[%1], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
%dmk_vmovups_offset = x86.dmk.vmovups [%1 + 8], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovups_offset = x86.dmk.vmovups[%1 + 8], %k1 : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
%dmk_vmovups_z = x86.dmk.vmovups [%1], %k1 {z} : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg
// CHECK-NEXT: %dmk_vmovups_z = x86.dmk.vmovups[%1], %k1 {z} : (!x86.reg64, !x86.avx512maskreg) -> !x86.avx512reg

// ---- msk.vmovapd (masked store) ----
x86.msk.vmovapd [%1], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
// CHECK-NEXT: x86.msk.vmovapd[%1], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
x86.msk.vmovapd [%1 + 8], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
// CHECK-NEXT: x86.msk.vmovapd[%1 + 8], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()

// ---- msk.vmovupd (masked store) ----
x86.msk.vmovupd [%1], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
// CHECK-NEXT: x86.msk.vmovupd[%1], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
x86.msk.vmovupd [%1 + 8], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
// CHECK-NEXT: x86.msk.vmovupd[%1 + 8], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()

// ---- msk.vmovaps (masked store) ----
x86.msk.vmovaps [%1], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
// CHECK-NEXT: x86.msk.vmovaps[%1], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
x86.msk.vmovaps [%1 + 8], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
// CHECK-NEXT: x86.msk.vmovaps[%1 + 8], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()

// ---- msk.vmovups (masked store) ----
x86.msk.vmovups [%1], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
// CHECK-NEXT: x86.msk.vmovups[%1], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
x86.msk.vmovups [%1 + 8], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()
// CHECK-NEXT: x86.msk.vmovups[%1 + 8], %zmm1, %k1 : (!x86.reg64, !x86.avx512reg, !x86.avx512maskreg) -> ()


// ---- vmovntpd ----
x86.ms.vmovntpd [%1 + 8], %xmm1 : (!x86.reg64, !x86.ssereg) -> ()
// CHECK-NEXT: x86.ms.vmovntpd [%1 + 8], %xmm1 : (!x86.reg64, !x86.ssereg) -> ()
x86.ms.vmovntpd [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
// CHECK-NEXT: x86.ms.vmovntpd [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
x86.ms.vmovntpd [%1 + 8], %zmm1 : (!x86.reg64, !x86.avx512reg) -> ()
// CHECK-NEXT: x86.ms.vmovntpd [%1 + 8], %zmm1 : (!x86.reg64, !x86.avx512reg) -> ()


// ---- vmovntps ----
x86.ms.vmovntps [%1 + 8], %xmm1 : (!x86.reg64, !x86.ssereg) -> ()
// CHECK-NEXT: x86.ms.vmovntps [%1 + 8], %xmm1 : (!x86.reg64, !x86.ssereg) -> ()
x86.ms.vmovntps [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
// CHECK-NEXT: x86.ms.vmovntps [%1 + 8], %ymm1 : (!x86.reg64, !x86.avx2reg) -> ()
x86.ms.vmovntps [%1 + 8], %zmm1 : (!x86.reg64, !x86.avx512reg) -> ()
// CHECK-NEXT: x86.ms.vmovntps [%1 + 8], %zmm1 : (!x86.reg64, !x86.avx512reg) -> ()
...
%vpermpd = x86.dss.vpermpd %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
// CHECK: %vpermpd = x86.dss.vpermpd %zmm1, %zmm2 : (!x86.avx512reg, !x86.avx512reg) -> !x86.avx512reg
...
%vshufpd = x86.dssi.vshufpd %xmm0, %xmm1, 1 : (!x86.ssereg, !x86.ssereg) -> !x86.ssereg
// CHECK-NEXT: %vshufpd = x86.dssi.vshufpd %xmm0, %xmm1, 1 : (!x86.ssereg, !x86.ssereg) -> !x86.ssereg

// ---- kmov -----

%ks_kmovb = x86.ks.kmovb %0 : (!x86.reg64) -> !x86.avx512maskreg
// CHECK-NEXT: %ks_kmovb = x86.ks.kmovb %0 : (!x86.reg64) -> !x86.avx512maskreg
%dk_kmovb = x86.dk.kmovb %ks_kmovb : (!x86.avx512maskreg) -> !x86.reg64
// CHECK-NEXT: %dk_kmovb = x86.dk.kmovb %ks_kmovb : (!x86.avx512maskreg) -> !x86.reg64

%ks_kmovw = x86.ks.kmovw %0 : (!x86.reg64) -> !x86.avx512maskreg
// CHECK-NEXT: %ks_kmovw = x86.ks.kmovw %0 : (!x86.reg64) -> !x86.avx512maskreg
%dk_kmovw = x86.dk.kmovw %ks_kmovw : (!x86.avx512maskreg) -> !x86.reg64
// CHECK-NEXT: %dk_kmovw = x86.dk.kmovw %ks_kmovw : (!x86.avx512maskreg) -> !x86.reg64

%ks_kmovd = x86.ks.kmovd %0 : (!x86.reg64) -> !x86.avx512maskreg
// CHECK-NEXT: %ks_kmovd = x86.ks.kmovd %0 : (!x86.reg64) -> !x86.avx512maskreg
%dk_kmovd = x86.dk.kmovd %ks_kmovd : (!x86.avx512maskreg) -> !x86.reg64
// CHECK-NEXT: %dk_kmovd = x86.dk.kmovd %ks_kmovd : (!x86.avx512maskreg) -> !x86.reg64

%ks_kmovq = x86.ks.kmovq %0 : (!x86.reg64) -> !x86.avx512maskreg
// CHECK-NEXT: %ks_kmovq = x86.ks.kmovq %0 : (!x86.reg64) -> !x86.avx512maskreg
%dk_kmovq = x86.dk.kmovq %ks_kmovq : (!x86.avx512maskreg) -> !x86.reg64
// CHECK-NEXT: %dk_kmovq = x86.dk.kmovq %ks_kmovq : (!x86.avx512maskreg) -> !x86.reg64
