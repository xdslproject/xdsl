...
// CHECK-NEXT:      "gpu.dealloc"(%3) : (memref<64x64xindex, strided<[2, 4], offset: 6>, 2 : i32>) -> ()
// CHECK-NEXT:      "gpu.dealloc"(%4) : (memref<?xindex>) -> ()
// CHECK-NEXT:      "gpu.dealloc"(%5) : (memref<?x?x?xindex>) -> ()
