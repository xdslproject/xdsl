...
builtin.module {
  ...
  ^bb0(%arg0 : i32, %arg1 : i32, %arg2 : f32, %arg3 : f32):
    ...
    %13 = "llvm.fadd"(%arg2, %arg3) : (f32, f32) -> f32
    %14 = "llvm.fsub"(%arg2, %arg3) : (f32, f32) -> f32
    %15 = "llvm.fmul"(%arg2, %arg3) : (f32, f32) -> f32
    %16 = "llvm.fdiv"(%arg2, %arg3) : (f32, f32) -> f32
    %17 = "llvm.frem"(%arg2, %arg3) : (f32, f32) -> f32
    "llvm.return"() : () -> ()
  }) : () -> ()
