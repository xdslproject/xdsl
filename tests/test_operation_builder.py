...
class ResultOp(IRDLOperation):
    name: ClassVar[str] = "test.result_op"
...
class OptResultOp(IRDLOperation):
    name: ClassVar[str] = "test.opt_result_op"
...
class VarResultOp(IRDLOperation):
    name: ClassVar[str] = "test.var_result_op"
...
class OperandOp(IRDLOperation):
    name: ClassVar[str] = "test.operand_op"
...
class OptOperandOp(IRDLOperation):
    name: ClassVar[str] = "test.opt_operand_op"
...
class VarOperandOp(IRDLOperation):
    name: ClassVar[str] = "test.var_operand_op"
...
class TwoVarOperandOp(IRDLOperation):
    name: ClassVar[str] = "test.two_var_operand_op"
...
class OptionalAttrOp(IRDLOperation):
    name: ClassVar[str] = "test.opt_attr_op"
...
class RegionOp(IRDLOperation):
    name: ClassVar[str] = "test.region_op"
...
class SBRegionOp(IRDLOperation):
    name: ClassVar[str] = "test.sbregion_op"
...
class OptRegionOp(IRDLOperation):
    name: ClassVar[str] = "test.opt_region_op"
...
class TwoVarRegionOp(IRDLOperation):
    name: ClassVar[str] = "test.two_var_region_op"
