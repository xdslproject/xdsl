...
"builtin.module"() ({
  ...
  ^0(%0 : !stencil.field<[-1 : i32, -1 : i32], f64>, %1 : !stencil.field<[-1 : i32, -1 : i32], f64>):
    ...
    %4 = "stencil.load"(%2) {"lb" = #stencil.index<[-1 : i32, -1 : i32]>, "ub" = #stencil.index<[65 : i32, 65 : i32]>} : (!stencil.field<[72 : i32, 72 : i32], f64>) -> !stencil.temp<[66 : i32, 66 : i32], f64>
    %5 = "stencil.apply"(%4) ({
    ...
    }) {"lb" = #stencil.index<[0 : i32, 0 : i32]>, "ub" = #stencil.index<[64 : i32, 64 : i32]>} : (!stencil.temp<[66 : i32, 66 : i32], f64>) -> !stencil.temp<[64 : i32, 64 : i32], f64>
...
// CHECK-NEXT:     %4 = "stencil.load"(%2) {"lb" = #stencil.index<[-1 : i32, -1 : i32]>, "ub" = #stencil.index<[65 : i32, 65 : i32]>} : (!stencil.field<[72 : i32, 72 : i32], f64>) -> !stencil.temp<[66 : i32, 66 : i32], f64>
...
// CHECK-NEXT:     }) {"lb" = #stencil.index<[0 : i32, 0 : i32]>, "ub" = #stencil.index<[64 : i32, 64 : i32]>} : (!stencil.temp<[66 : i32, 66 : i32], f64>) -> !stencil.temp<[64 : i32, 64 : i32], f64>
