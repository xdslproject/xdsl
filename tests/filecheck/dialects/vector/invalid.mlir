...
func.func @insert_vector_type(%a: vector<4xf32>, %b: vector<4x8x16xf32>) {
  // CHECK: Expected position attribute rank + source rank (2) to match dest vector rank (3).
...
func.func @extract_position_rank_overflow(%arg0: vector<4x8x16xf32>) {
  // CHECK: Expected position attribute rank (4) to match result vector rank (3).
...
func.func @extract_position_rank_overflow_generic(%arg0: vector<4x8x16xf32>) {
  // CHECK: Expected position attribute rank + source rank (5) to match result vector rank (3).
...
func.func @extract_0d(%arg0: vector<f32>) {
  // CHECK: Expected position attribute rank (1) to match result vector rank (0).
