...
builtin.module {
  func.func private @stencil_offset_mapping(%0 : !stencil.field<?x?xf64>, %1 : !stencil.field<?x?xf64>) {
    ...
    %5 = "stencil.apply"(%4) ({
    ^0(%6 : !stencil.temp<[-1,65]x[-1,65]xf64>):
      %7 = "stencil.access"(%6) {"offset" = #stencil.index[-1, 0], "offset_mapping" = #stencil.index[1, 0]} : (!stencil.temp<[-1,65]x[-1,65]xf64>) -> f64
...
// CHECK-NEXT:      %4 = stencil.load %2 : !stencil.field<[-4,68]x[-4,68]xf64> -> !stencil.temp<[-1,65]x[-1,65]xf64>
// CHECK-NEXT:      %5 = stencil.apply(%6 = %4 : !stencil.temp<[-1,65]x[-1,65]xf64>) -> (!stencil.temp<[0,64]x[0,64]xf64>) {
// CHECK-NEXT:        %7 = stencil.access %6 [-1, 0] attributes {"offset_mapping" = #stencil.index[1, 0]} : !stencil.temp<[-1,65]x[-1,65]xf64>
