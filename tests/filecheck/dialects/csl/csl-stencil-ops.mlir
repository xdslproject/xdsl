...
// CHECK-GENERIC-NEXT:     ^bb0(%2: !stencil.temp<[-1,2]x[-1,2]xtensor<512xf32>>, %3: tensor<4x510xf32>):
...
// CHECK-GENERIC-NEXT:       ^bb0(%20: f32, %21: f32):
...
// CHECK-GENERIC-NEXT:     ^bb0(%recv: tensor<4x255xf32>, %offset: index, %iter_arg: tensor<510xf32>):
...
// CHECK-GENERIC-NEXT:       ^bb0(%21: f32, %22: f32):
...
// CHECK-GENERIC-NEXT:     ^bb0(%1: tensor<4x255xf32>, %2: index, %3: tensor<510xf32>):
...
// CHECK-GENERIC-NEXT:     }, {
// CHECK-GENERIC-NEXT:     ^bb0(%12: !stencil.field<[-1,1023]x[-1,511]xtensor<512xf32>>, %13: tensor<510xf32>):
