...
// CHECK-NEXT:      %2 = asm.to_reg %1 : i32 -> !x86.reg32
...
// CHECK-NEXT:     %g_1 = asm.to_reg %g : i32 -> !x86.reg32
// CHECK-NEXT:     %23 = x86.ds.mov %g_1 : (!x86.reg32) -> !x86.reg32<eax>
// CHECK-NEXT:     x86_func.ret
// CHECK-NEXT:   }
// CHECK-NEXT: }
