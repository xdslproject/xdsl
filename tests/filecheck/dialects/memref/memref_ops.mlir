...
builtin.module {
  ...
  func.func private @memref_test() {
    ...
    %19 = "memref.collapse_shape"(%5) {"reassociation" = [[0, 1]]} : (memref<10x2xindex>) -> memref<20xindex>
    %20 = "memref.expand_shape"(%19) {"reassociation" = [[0, 1]]} : (memref<20xindex>) -> memref<2x10xindex>
...
// CHECK-NEXT:     %{{.*}} = "memref.collapse_shape"(%{{.*}}) <{"reassociation" = [[0 : i64, 1 : i64]]}> : (memref<10x2xindex>) -> memref<20xindex>
// CHECK-NEXT:     %{{.*}} = "memref.expand_shape"(%{{.*}}) <{"reassociation" = [[0 : i64, 1 : i64]]}> : (memref<20xindex>) -> memref<2x10xindex>
