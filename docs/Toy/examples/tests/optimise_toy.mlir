...
// CHECK:       builtin.module {
  ...
  }) {"sym_name" = "redundant_transpose", "function_type" = () -> ()} : () -> ()
...
// CHECK-NEXT:  }) {"sym_name" = "redundant_transpose", "function_type" = () -> ()} : () -> ()



  "toy.func"() ({
    %30 = "test.op"() : () -> tensor<2x3xf64>
...
// CHECK-NEXT:  "toy.func"() ({
// CHECK-NEXT:    %{{.*}} = "test.op"() : () -> tensor<2x3xf64>
// CHECK-NEXT:    %{{.*}} = "toy.reshape"(%1) : (tensor<2x3xf64>) -> tensor<2x3xf64>
// CHECK-NEXT:    "toy.return"(%{{.*}}) : (tensor<2x3xf64>) -> ()
// CHECK-NEXT:  }) {"sym_name" = "redundant_reshape", "function_type" = () -> ()} : () -> ()
