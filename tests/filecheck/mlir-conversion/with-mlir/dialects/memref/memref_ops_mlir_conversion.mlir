// RUN: xdsl-opt %s | $XDSL_MLIR_OPT --mlir-print-op-generic | xdsl-opt --print-op-generic | filecheck %s
...
"builtin.module"() ({
  ...
  "func.func"() ({
    ...
    %2 = memref.alloca() : memref<1xindex>
    ...
    %5 = "memref.alloc"() {operandSegmentSizes = array<i32: 0, 0>} : () -> memref<10x2xindex>
    ...
    %m1 = "memref.alloc"() {operandSegmentSizes = array<i32: 0, 0>}: () -> memref<100xi32, 10>
    %m2 = "memref.alloc"() {operandSegmentSizes = array<i32: 0, 0>}: () -> memref<100xi32, 9>
    %tag = "memref.alloc"() {operandSegmentSizes = array<i32: 0, 0>} : () -> memref<100xi32>
...
// CHECK-NEXT: %2 = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<1xindex>
...
// CHECK-NEXT: %5 = "memref.alloc"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<10x2xindex>
