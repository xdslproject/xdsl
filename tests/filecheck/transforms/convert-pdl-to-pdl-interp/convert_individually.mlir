...
// CHECK-NEXT:     pdl_interp.is_not_null %1 : !pdl.value -> ^bb18, ^bb1
// CHECK-NEXT:   ^bb1:
...
// CHECK-NEXT:     pdl_interp.is_not_null %4 : !pdl.operation -> ^bb4, ^bb2
// CHECK-NEXT:   ^bb4:
// CHECK-NEXT:     pdl_interp.check_operation_name of %0 is "arith.muli" -> ^bb5, ^bb2
// CHECK-NEXT:   ^bb5:
// CHECK-NEXT:     pdl_interp.check_operand_count of %0 is 2 -> ^bb6, ^bb2
// CHECK-NEXT:   ^bb6:
// CHECK-NEXT:     pdl_interp.check_result_count of %0 is 1 -> ^bb7, ^bb2
// CHECK-NEXT:   ^bb7:
// CHECK-NEXT:     %5 = pdl_interp.get_operand 0 of %0
// CHECK-NEXT:     pdl_interp.is_not_null %5 : !pdl.value -> ^bb8, ^bb2
// CHECK-NEXT:   ^bb8:
// CHECK-NEXT:     pdl_interp.is_not_null %3 : !pdl.value -> ^bb9, ^bb2
// CHECK-NEXT:   ^bb9:
// CHECK-NEXT:     pdl_interp.check_operation_name of %4 is "arith.divui" -> ^bb10, ^bb2
// CHECK-NEXT:   ^bb10:
// CHECK-NEXT:     pdl_interp.check_operand_count of %4 is 2 -> ^bb11, ^bb2
// CHECK-NEXT:   ^bb11:
// CHECK-NEXT:     pdl_interp.check_result_count of %4 is 1 -> ^bb12, ^bb2
// CHECK-NEXT:   ^bb12:
// CHECK-NEXT:     %6 = pdl_interp.get_operand 0 of %4
// CHECK-NEXT:     pdl_interp.is_not_null %6 : !pdl.value -> ^bb13, ^bb2
// CHECK-NEXT:   ^bb13:
// CHECK-NEXT:     %7 = pdl_interp.get_operand 1 of %4
// CHECK-NEXT:     pdl_interp.is_not_null %7 : !pdl.value -> ^bb14, ^bb2
// CHECK-NEXT:   ^bb14:
// CHECK-NEXT:     %8 = pdl_interp.get_result 0 of %4
// CHECK-NEXT:     pdl_interp.is_not_null %8 : !pdl.value -> ^bb15, ^bb2
// CHECK-NEXT:   ^bb15:
// CHECK-NEXT:     pdl_interp.are_equal %8, %3 : !pdl.value -> ^bb16, ^bb2
// CHECK-NEXT:   ^bb16:
// CHECK-NEXT:     %9 = pdl_interp.get_value_type of %8 : !pdl.type
// CHECK-NEXT:     %10 = pdl_interp.get_value_type of %2 : !pdl.type
// CHECK-NEXT:     pdl_interp.are_equal %9, %10 : !pdl.type -> ^bb17, ^bb2
// CHECK-NEXT:   ^bb17:
// CHECK-NEXT:     pdl_interp.record_match @rewriters::@pdl_generated_rewriter(%5, %6, %9, %7, %0 : !pdl.value, !pdl.value, !pdl.type, !pdl.value, !pdl.operation) : benefit(1), loc([]), root("arith.muli") -> ^bb2
// CHECK-NEXT:   ^bb18:
...
// CHECK-NEXT:     pdl_interp.is_not_null %12 : !pdl.operation -> ^bb19, ^bb1
// CHECK-NEXT:   ^bb19:
// CHECK-NEXT:     pdl_interp.check_operation_name of %0 is "arith.divui" -> ^bb20, ^bb1
// CHECK-NEXT:   ^bb20:
// CHECK-NEXT:     pdl_interp.check_operand_count of %0 is 2 -> ^bb21, ^bb1
// CHECK-NEXT:   ^bb21:
// CHECK-NEXT:     pdl_interp.check_result_count of %0 is 1 -> ^bb22, ^bb1
// CHECK-NEXT:   ^bb22:
// CHECK-NEXT:     pdl_interp.is_not_null %11 : !pdl.value -> ^bb23, ^bb1
// CHECK-NEXT:   ^bb23:
// CHECK-NEXT:     %13 = pdl_interp.get_operand 1 of %0
// CHECK-NEXT:     pdl_interp.is_not_null %13 : !pdl.value -> ^bb24, ^bb1
// CHECK-NEXT:   ^bb24:
// CHECK-NEXT:     pdl_interp.check_operation_name of %12 is "arith.muli" -> ^bb25, ^bb1
// CHECK-NEXT:   ^bb25:
// CHECK-NEXT:     pdl_interp.check_operand_count of %12 is 2 -> ^bb26, ^bb1
// CHECK-NEXT:   ^bb26:
// CHECK-NEXT:     pdl_interp.check_result_count of %12 is 1 -> ^bb27, ^bb1
// CHECK-NEXT:   ^bb27:
// CHECK-NEXT:     %14 = pdl_interp.get_operand 0 of %12
// CHECK-NEXT:     pdl_interp.is_not_null %14 : !pdl.value -> ^bb28, ^bb1
// CHECK-NEXT:   ^bb28:
// CHECK-NEXT:     %15 = pdl_interp.get_operand 1 of %12
// CHECK-NEXT:     pdl_interp.is_not_null %15 : !pdl.value -> ^bb29, ^bb1
// CHECK-NEXT:   ^bb29:
// CHECK-NEXT:     %16 = pdl_interp.get_result 0 of %12
// CHECK-NEXT:     pdl_interp.is_not_null %16 : !pdl.value -> ^bb30, ^bb1
// CHECK-NEXT:   ^bb30:
// CHECK-NEXT:     pdl_interp.are_equal %16, %11 : !pdl.value -> ^bb31, ^bb1
// CHECK-NEXT:   ^bb31:
// CHECK-NEXT:     %17 = pdl_interp.get_value_type of %16 : !pdl.type
// CHECK-NEXT:     %18 = pdl_interp.get_value_type of %1 : !pdl.type
// CHECK-NEXT:     pdl_interp.are_equal %17, %18 : !pdl.type -> ^bb32, ^bb1
// CHECK-NEXT:   ^bb32:
