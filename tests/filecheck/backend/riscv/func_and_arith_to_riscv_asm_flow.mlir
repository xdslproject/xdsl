// RUN: xdsl-opt %s -p convert-func-to-riscv-func,convert-snrt-to-riscv,convert-arith-to-riscv,reconcile-unrealized-casts,riscv-allocate-registers -t riscv-asm | filecheck %s
