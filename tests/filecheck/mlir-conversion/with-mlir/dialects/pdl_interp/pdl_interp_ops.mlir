...
// CHECK-NEXT:       pdl_interp.switch_attribute %9 to [42 : i32, true](^bb20, ^bb1) -> ^bb1
// CHECK-NEXT:     ^bb20:
// CHECK-NEXT:       %10 = pdl_interp.apply_constraint "myConstraint"(%9 : !pdl.attribute) : !pdl.operation {isNegated = true} -> ^bb16, ^bb1
// CHECK-NEXT:     ^bb21:
