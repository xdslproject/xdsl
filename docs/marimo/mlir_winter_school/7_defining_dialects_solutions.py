...
def _():
    ...
    from xdsl.ir import Operation, SSAValue, Region, Block, ParametrizedAttribute, Attribute, TypeAttribute
    ...
    from xdsl.irdl import irdl_op_definition, IRDLOperation, irdl_attr_definition, operand_def, result_def, ParameterDef, traits_def
