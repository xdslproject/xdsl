...
// CHECK-NEXT:     %res_2 = equivalence.class %res_1 : index
// CHECK-NEXT:     equivalence.yield %res_2 : index
// CHECK-NEXT:   }
...
// CHECK-NEXT:     %step_1 = equivalence.class %step : i32
// CHECK-NEXT:     %sum_init = arith.constant 36 : i32
// CHECK-NEXT:     %sum_init_1 = equivalence.class %sum_init : i32
...
// CHECK-NEXT:     }
// CHECK-NEXT:     %sum_2 = equivalence.class %sum_1 : i32
// CHECK-NEXT:     equivalence.yield %sum_2 : i32
// CHECK-NEXT:   }
...
// CHECK-NEXT:     equivalence.yield %a_2, %b_2 : index, index
// CHECK-NEXT:   }
