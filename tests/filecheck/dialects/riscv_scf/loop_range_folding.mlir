...
// CHECK-NEXT:        %{{.*}} = riscv.sub %c64, %c0 : (!riscv.reg<>, !riscv.reg<>) -> !riscv.reg<>
// CHECK-NEXT:        %{{.*}} = riscv.mul %6, %{{.*}} : (!riscv.reg<>, !riscv.reg<>) -> !riscv.reg<>
// CHECK-NEXT:        %{{.*}} = riscv.add %c0, %{{.*}} : (!riscv.reg<>, !riscv.reg<>) -> !riscv.reg<>
