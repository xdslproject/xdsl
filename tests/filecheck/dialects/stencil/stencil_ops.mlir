...
// CHECK-NEXT:     }) : (!stencil.temp<?xf64>) -> !stencil.temp<?xf64>
// CHECK-NEXT:      %10 = "stencil.combine"(%6, %7) {"dim" = 0 : index, "index" = 11 : index, "operandSegmentSizes" = array<i32: 1, 1, 0, 0>} : (!stencil.temp<?xf64>, !stencil.temp<?xf64>) -> !stencil.temp<?xf64>
...
// CHECK-NEXT:     %5 = "stencil.apply"(%4) ({
// CHECK-NEXT:     ^0(%6 : !stencil.temp<[-1,65]x[-1,65]xf64>):
// CHECK-NEXT:       %7 = "stencil.access"(%6) {"offset" = #stencil.index<-1, 0>, "offset_mapping" = #stencil.index<0, 1>} : (!stencil.temp<[-1,65]x[-1,65]xf64>) -> f64
...
// CHECK-NEXT:     %5 = "stencil.apply"(%4) ({
// CHECK-NEXT:     ^0(%6 : !stencil.temp<[-1,65]x[-1,65]xf64>):
// CHECK-NEXT:       %i = "stencil.index"() {"dim" = 0 : index, "offset" = #stencil.index<-1, -1>} : () -> index
// CHECK-NEXT:       %j = "stencil.index"() {"dim" = 1 : index, "offset" = #stencil.index<1, 1>} : () -> index
