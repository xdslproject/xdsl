...
- [ ] Comparison against https://github.com/makslevental/mlir-python-extras
- [ ] Change implementation to valid Python types (i32 vs I32)
- [ ] Add `bytecodegen` method to `FrontendProgram` to convert back from MLIR
      to Python bytecode
      - [ ] Write xDSL lowering pass from some low dialect to python bytecode
      - [ ] Add support for caching this generated bytecode at build time of a
            library
- [ ] Add `run` method to `FrontendProgram` to run the optimised bytecode
