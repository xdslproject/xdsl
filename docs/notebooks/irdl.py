...
def _(mo):
    mo.md(r"""
    Our attribute definition also defines accessors for each parameter based on the name given in the `param_def` field:
    """)
    return
...
def _(mo):
    mo.md(r"""
    Generated accessors return a list of SSA variables instead of a single variable:
    """)
    return
