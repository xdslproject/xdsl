...
"builtin.module"() ({
  ...
  %7 = "llvm.getelementptr"(%6, %0) {"elem_type" = i32, "rawConstantIndices" = array<i32: -2147483648>} : (!llvm.ptr<index>, i64) -> !llvm.ptr<i32>
...
// CHECK-NEXT:   %7 = "llvm.getelementptr"(%6, %0) {"elem_type" = i32, "rawConstantIndices" = array<i32: -2147483648>} : (!llvm.ptr<index>, i64) -> !llvm.ptr<i32>
